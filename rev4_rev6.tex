...
%DIF 11c11
%DIF < %% whichever is most appropriate for your purposes.
%DIF -------
%% whichever is most appropriate for your purposes.chap5_xcor/ %DIF > 
%DIF -------
%%
...
\author{Abraham R. Neben\DIFdelbegin %DIFDELCMD < \altaffilmark{1}%%%
\DIFdelend \DIFaddbegin \altaffilmark{1,2}\DIFaddend ,
Brian Stalder\DIFdelbegin %DIFDELCMD < \altaffilmark{2}%%%
\DIFdelend \DIFaddbegin \altaffilmark{3}\DIFaddend ,
Jacqueline N. Hewitt\DIFdelbegin %DIFDELCMD < \altaffilmark{1}%%%
\DIFdelend \DIFaddbegin \altaffilmark{1,2}\DIFaddend ,
John L. Tonry\DIFdelbegin %DIFDELCMD < \altaffilmark{2}%%%
\DIFdelend \DIFaddbegin \altaffilmark{3}\DIFaddend }

\affil{\altaffilmark{1}MIT Kavli Institute, Massachusetts Institute of Technology, Cambridge, MA 02139}
\DIFdelbegin %DIFDELCMD < \affil{\altaffilmark{2}Institute for Astronomy, University of Hawaii, 2680 Woodlawn Drive, Honolulu, HI 96822}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \affil{\altaffilmark{2}Department of Physics, Massachusetts Institute of Technology, Cambridge, MA 02139}
...
A detection of the predicted anticorrelation between $21$\,cm and either Ly$\alpha$ or H$\alpha$ from the Epoch of Reionization (EOR) would be a powerful probe of the \DIFdelbegin \DIFdel{astrophysics of the EOR}\DIFdelend \DIFaddbegin \DIFadd{first galaxies}\DIFaddend . While 3D intensity maps isolate foregrounds in \DIFdelbegin \DIFdel{the lowest }\DIFdelend \DIFaddbegin \DIFadd{low }\DIFaddend $k_\parallel$ modes, infrared surveys cannot yet match the field of view and redshift resolution of radio intensity mapping experiments. In contrast, 2D (i.e., broad band) infrared intensity maps can be measured with current experiments and are \DIFdelbegin \DIFdel{not sensitivity limited . We find that }\DIFdelend \DIFaddbegin \DIFadd{limited by foregrounds instead of photon or thermal noise. We show }\DIFaddend 2D experiments can measure \DIFdelbegin \DIFdel{of order 100}%DIFDELCMD < \% %%%
\DIFdel{of }\DIFdelend \DIFaddbegin \DIFadd{most of }\DIFaddend the 3D fluctuation power at $k<0.2$\,Mpc$^{-1}$ while preserving \DIFdelbegin \DIFdel{the }\DIFdelend \DIFaddbegin \DIFadd{its }\DIFaddend correlation properties. However, we show \DIFdelbegin \DIFdel{that }\DIFdelend foregrounds pose two challenges: (1) simple geometric effects \DIFdelbegin \DIFdel{result in }\DIFdelend \DIFaddbegin \DIFadd{produce }\DIFaddend percent-level correlations between \DIFdelbegin \DIFdel{fluxes in these two bands}\DIFdelend \DIFaddbegin \DIFadd{radio and infrared fluxes}\DIFaddend , even if their luminosities are uncorrelated; and (2) \DIFdelbegin \DIFdel{the largely uncorrelated }\DIFdelend radio and infrared foreground residuals contribute \DIFdelbegin \DIFdel{a }\DIFdelend sample variance noise to the cross spectrum. The first challenge demands better foreground masking and subtraction, while the second \DIFdelbegin \DIFdel{requires measurements over }\DIFdelend \DIFaddbegin \DIFadd{demands }\DIFaddend large fields of view \DIFdelbegin \DIFdel{with many independent samples to average down }\DIFdelend \DIFaddbegin \DIFadd{to average away }\DIFaddend uncorrelated radio and infrared power. Using radio \DIFdelbegin \DIFdel{and infrared }\DIFdelend observations from the Murchison Widefield Array \DIFdelbegin \DIFdel{(MWA) and }\DIFdelend \DIFaddbegin \DIFadd{and near-infrared observations from }\DIFaddend the Asteroid Terrestrial-impact Last Alert System\DIFdelbegin \DIFdel{(ATLAS) }\DIFdelend \DIFaddbegin \DIFadd{, }\DIFaddend we set an upper limit on \DIFaddbegin \DIFadd{residual foregrounds of }\DIFaddend the 21\,cm--Ly$\alpha$ \DIFaddbegin \DIFadd{cross }\DIFaddend power spectrum at $z\sim7$ of $\Delta^2<181$\,$(\text{kJy/sr}\cdot \text{mK})$ (95\%) at $\ell\sim800$. We predict \DIFdelbegin \DIFdel{the }\DIFdelend levels of foreground \DIFdelbegin \DIFdel{flux correlation and the }\DIFdelend \DIFaddbegin \DIFadd{correlation and }\DIFaddend sample variance noise in \DIFdelbegin \DIFdel{several possible }\DIFdelend future experiments, \DIFdelbegin \DIFdel{and show }\DIFdelend \DIFaddbegin \DIFadd{showing }\DIFaddend that higher resolution \DIFdelbegin \DIFdel{radio and infrared }\DIFdelend surveys such as LOFAR, SKA-LOW, \DIFdelbegin \DIFdel{Hubble, }\DIFdelend \DIFaddbegin \DIFadd{and the }\DIFaddend Dark Energy Survey can start to probe \DIFdelbegin \DIFdel{optimistic }\DIFdelend models of the 21\,cm--Ly$\alpha$ EOR cross spectrum. 
\end{abstract}
...
\end{equation}
Here $V$ is the survey volume, and $dV$ is the voxel size. Note that $P(\vec{k})$ has units of $[I]^2\cdot\text{Mpc}^3$, and that we often plot instead the more intuitive quantity \DIFdelbegin \DIFdel{$\Delta(\vec{k})=[k^3P(\vec{k})/2\pi^2]^{1/2}$}\DIFdelend \DIFaddbegin \DIFadd{$\Delta(k)=[k^3 P(k)/2\pi^2]^{1/2}$, where $P(k)$ is the average of $P(\vec{k})$ within the 1D power spectrum bin $k$}\DIFaddend .
...
\end{equation}
\DIFaddbegin \DIFadd{where }\DIFaddend $\Omega$ is the survey solid angle, and $d\Omega$ is the pixel size. Thus, over a narrow field of view, we need only evaluate a \DIFdelbegin \DIFdel{fourier }\DIFdelend \DIFaddbegin \DIFadd{Fourier }\DIFaddend transform to estimate the angular power spectrum. Writing this out in detail gives\footnote{Note that the normalization of $d\theta^2/N^2$ has been misstated as $1/N^2$ by \citet{zemcov14} (Eqn. 3 of their supplement) and $d\theta^2$ by \citet{cooray12} (Eqn. 1 of their supplement).} 
\begin{equation}
\label{eqn:Cldef}
	C(\DIFaddbegin \vec\DIFaddend \ell(a,b))=\DIFdelbegin %DIFDELCMD < \left\langle%%%
\DIFdelend \left|\sum_{m,n}I(m,n)\exp\left(-\frac{2\pi i}{N}  (am+bn)\right)\right|^2\DIFdelbegin %DIFDELCMD < \right\rangle%%%
\DIFdelend \frac{d\theta^2}{N^2}
\end{equation}
where $d\theta=d\theta_x=d\theta_y$ is the pixel size, $N\equiv N_x=N_y$ is the number of pixels on a side of a square image, \DIFaddbegin \DIFadd{and $-N/2 \leq a,b\leq N/2$ are integers. Further }\DIFaddend $\ell^2=\ell_x^2+\ell_y^2$, and 
\begin{eqnarray}
\ell_x&=&2\pi a/N d\theta \label{eqn:elldef}\\
\ell_y&=&2\pi b/Nd\theta \label{eqn:elldef2}
\end{eqnarray}
Note that $C(\vec{\ell})$ has the units of $[I]^2\cdot d\theta^2$, and we often work with \DIFdelbegin \DIFdel{$\Delta(\vec{\ell})=[\ell(\ell+1)C(\vec{\ell})/2\pi]^{1/2}$ }\DIFdelend \DIFaddbegin \DIFadd{$\Delta(\ell)=[\ell(\ell+1)C(\ell)/2\pi]^{1/2}$ }\DIFaddend which has the same units\footnote{Over small fields of view, we must necessarily work at large $\ell$, implying that $\ell(\ell+1)\approx\ell^2$, which has units of inverse steradians in view of Eqns. \ref{eqn:elldef} and \ref{eqn:elldef2}} as I. \DIFaddbegin \DIFadd{Here $C(\ell)$ is the average of $C(\vec\ell)$ within the 1D power spectrum bin $\ell$.
}\DIFaddend 
...
\DIFaddbegin \DIFadd{We use MWA image products produced by }\citet{beardsley16}\DIFadd{. }\DIFaddend The MWA observations are recorded as 2\,min ``snapshots'' which are flagged for RFI using COTTER \citep{AndreMWARFI}, then calibrated and imaged using Fast Holographic Deconvolution\footnote{\ULurl{https://github.com/EoRImaging/FHD}}\DIFdelbegin %DIFDELCMD < \citep{fhd}%%%
\DIFdelend . Model visibilities are simulated from a foreground model of diffuse  \DIFdelbegin %DIFDELCMD < \citep{beardsley16} %%%
\DIFdelend and point source \citep{PattiCatalog1} emission in the field, and used for both calibration and foreground subtraction. For each snapshot, FHD produces naturally weighted data and model image cubes as well as primary and synthesized beam cubes. FHD outputs these ``cubes'' in HEALPix format per frequency. Note that this processing is performed in parallel on ``odd'' and ``even'' data cubes whose data are interleaved at a 2\,sec cadence for the purpose of \DIFdelbegin \DIFdel{eliminating the }\DIFdelend \DIFaddbegin \DIFadd{avoiding a thermal }\DIFaddend noise bias in \DIFdelbegin \DIFdel{power spectrum estimation. }\DIFdelend \DIFaddbegin \DIFadd{autospectrum analyses. In cross spectrum analyses, the noise between the radio and IR images is independent, so in principle we should average the odd and even cubes together to achieve the lowest noise. However, for simplicity, we use only the even cube in this work given that thermal noise is much smaller than residual foregrounds.
}\DIFaddend 

\DIFdelbegin \DIFdel{We }\DIFdelend \DIFaddbegin \DIFadd{Following }\citet{dillonneben}\DIFadd{, we }\DIFaddend rotate these HEALPix maps so the MWA field center lies at the north pole, then project the pixels onto the $xy$ plane to obtain naturally weighted image space cubes of the raw data ($I_\text{nat}$), the model data ($I_\text{nat,mod}$), the synthesized beam ($I_w$) (i.e., the \DIFdelbegin \DIFdel{fourier }\DIFdelend \DIFaddbegin \DIFadd{Fourier }\DIFaddend transform of the $uv$ weights), and the primary beam, all in orthographic projection. We flag the upper and lower 80\,kHz channels in each of 24 coarse channels across the band to mitigate aliasing, average each cube over frequency to make broad band images, then apply uniform weighting \DIFdelbegin \DIFdel{as in }%DIFDELCMD < \citet{dillonneben} %%%
\DIFdelend using
\begin{equation}
...
\end{equation}
where $\tilde{I}_i(\vec{u}) = \sum_{\vec{\theta}} I_i(\vec{\theta}) e^{2\pi i\vec{\theta}\cdot\vec{u}} d\Omega$ for $i=\text{nat},w$. The units of $I_\text{nat}$ and $I_w$ are \DIFdelbegin \DIFdel{most easily }\DIFdelend \DIFaddbegin \DIFadd{Jy/sr and 1/sr, respectively, as }\DIFaddend seen from their approximate definitions of $I_\text{nat}(\vec{\theta})\approx\sum_j V(\vec{u}_j)e^{-2\pi i\vec{u}_j\cdot\vec{\theta}}du^2$ and $I_w(\vec{\theta})\approx\sum_j e^{-2\pi i\vec{u}_j\cdot\vec{\theta}}du^2$, where the sums are over all measured visibilities $V(\vec{u}_j)$ in units of Jy. These definitions are only approximate because FHD performs corrections to account for \DIFdelbegin \DIFdel{$w$ terms}\DIFdelend \DIFaddbegin \DIFadd{wide-field effects}\DIFaddend .
...
Lastly, we run SExtractor\footnote{\ULurl{http://www.astromatic.net/software/sextractor}} \citep{sextractor} on our wide $20^\circ$ ATLAS composite image to generate an 850\,nm catalog. We allow local background bias and noise estimation, set pixel saturation at 20,000 counts to avoid artifacts, and use the {\tt AUTO} aperture profile. We extract sources down to $3\sigma$ above the background, in order to achieve the most complete point source mask. Given that our ATLAS observations have been calibrated and imaged through a preliminary pipeline, we cross match these sources with sources closer than $1''$ in the AAVSO\footnote{American Association of Variable Star Observers} Photometric All Sky Survey\footnote{\ULurl{https://www.aavso.org/download-apass-data}} \citep{apass}, \DIFdelbegin \DIFdel{finding }\DIFdelend \DIFaddbegin \DIFadd{which is complete to $\sim3$}\,\DIFadd{mJy. We find }\DIFaddend matches for $\sim20\%$ of ATLAS detections\DIFaddbegin \DIFadd{, not unreasonable given the deeper flux limit of ATLAS compared to APASS}\DIFaddend . Fig. \ref{fig:ATLASvsAPASS} (top) shows a 2D histogram of APASS versus ATLAS magnitude as a function of ATLAS magnitude. We fit a \DIFdelbegin \DIFdel{gaussian }\DIFdelend \DIFaddbegin \DIFadd{Gaussian }\DIFaddend to the relative magnitude for sources brighter than 13 mag, and find that our roughly calibrated ATLAS sources are too bright by $0.279\pm0.003$\,mag. Applying this correction, we plot a histogram of ATLAS source fluxes in Fig. \ref{fig:cataloghistograms}) (right panel), finding that our survey is complete to roughly 0.5\,mJy\DIFaddbegin \DIFadd{, a factor of 6 deeper than the APASS survey}\DIFaddend .
...
\caption[Color-color plots of ALLWISE sources showing that cutting out the brightest 10\% cleanly removes the stars.]{The ALLWISE sources are plotted in the color--color space of \citet{Wright2010} prior to any flux cuts (left panel), showing cluster of stars near (0,0). \DIFaddbeginFL \DIFaddFL{The colorbar shows the number of sources in each cell. }\DIFaddendFL Then after cutting out the brightest 10\% of sources (fainter than 18.25\, AB mag), the stars are cleanly removed. We roughly split the remaining sources into AGNs (\DIFdelbeginFL \DIFdelFL{$W_{12}>0.16$}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$W_{12}>0.6$}\DIFaddendFL ) and starburst galaxies (SF) (\DIFdelbeginFL \DIFdelFL{$W_{12}<0.16$}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$W_{12}<0.6$}\DIFaddendFL ) \DIFdelbeginFL %DIFDELCMD < \citep{nikutta14,kurcz16}%%%
\DIFdelendFL \DIFaddbeginFL \citep{mingo16}\DIFaddFL{, where  $W_{12}\equiv$ }[\DIFaddFL{3.4}\,\DIFaddFL{$\mu$m}] \DIFaddFL{-- }[\DIFaddFL{4.6}\,\DIFaddFL{$\mu$m}]\DIFaddFL{.}\DIFaddendFL }.
\label{fig:wisecolorcolor}
\end{figure*}

To further probe which mid infrared sources are responsible for this correlation, we make a rough cut to separate quasars and active galactic nuclei (AGN) (\DIFdelbegin \DIFdel{$W_{12}>0.16$}\DIFdelend \DIFaddbegin \DIFadd{$W_{12}>0.6$}\DIFaddend ) from starforming galaxies (SF) (\DIFdelbegin \DIFdel{$W_{12}<0.16$) }%DIFDELCMD < \citep{nikutta14,kurcz16}%%%
\DIFdelend \DIFaddbegin \DIFadd{$W_{12}<0.6$) }\citep{mingo16}\DIFaddend . In Fig. \ref{fig:wisexspec} we plot the power spectrum of 185\,MHz sources (left panel), 4.5\,$\mu$m AGN (center panel, blue points), and 4.5\,$\mu$m starforming galaxies (center panel, red points). In the right panel we plot the coherence (i.e., normalized cross spectrum) of the 185\,MHz catalog with AGN (blue) and with starforming galaxies (red). The AGN cut exhibits no significant correlation with the 185\,MHz sources, while the starforming galaxy cut exhibits a significant correlation rising from a few percent at $\ell\sim7000$ to 16\% at $\ell\sim300$. 
...
The fall of the correlation towards high $\ell$ is likely due \DIFdelbegin \DIFdel{in part }\DIFdelend to the MWA's $3'$ resolution at 185\,MHz, corresponding to a maximum $\ell$ of roughly \DIFdelbegin \DIFdel{4000, and in part to the similar fall in the 4.5}%DIFDELCMD < \,%%%
...
For a survey of a fixed angular field of view, uniform spatial distribution of objects, and \DIFdelbegin \DIFdel{cartesian }\DIFdelend \DIFaddbegin \DIFadd{Cartesian }\DIFaddend spacetime, the distribution of object distances \DIFdelbegin \DIFdel{$d$ grows as $d^2$, giving 
}%DIFDELCMD < \begin{equation}
\begin{displaymath}%DIFAUXCMD
%DIFDELCMD < 	%%%
\DIFdel{\beta }\end{displaymath}%DIFAUXCMD
\DIFdelend \DIFaddbegin \DIFadd{is $\rho(D)=\rho_0 D^2$. Assuming all the objects are between distances $D_\mintext$ and $D_\maxtext$, the normalization constant is $\rho_0=3/(D_\maxtext^3-D_\mintext^3)$.
}\begin{eqnarray}
	\DIFadd{\beta }&\DIFaddend =\DIFdelbegin \DIFdel{\frac{d_\maxtext^3-d_\mintext^3}{3d_\maxtext d_\mintext (d_\maxtext-d_\mintext)}
}%DIFDELCMD < \end{equation}
\end{eqnarray}%DIFAUXCMD
%DIFDELCMD < %%%
\begin{eqnarray}%DIFAUXCMD
\DIFdelend \DIFaddbegin & \DIFadd{\frac{\int_{D_\mintext}^{D_\maxtext}D^{-4}\rho(D)dD}{\left(\int_{D_\mintext}^{D_\maxtext}D^{-2}\rho(D)dD\right)^2}}\\
	 &\DIFadd{=}&\DIFadd{\frac{D_\maxtext^2+D_\maxtext D_\mintext+D_\mintext^2}{3D_\maxtext D_\mintext}
}\end{eqnarray}
\DIFaddend 
...
We begin by quantifying the 185\,MHz foreground residuals in angular power spectrum measurements. \DIFdelbegin \DIFdel{We ask how }\DIFdelend \DIFaddbegin \DIFadd{In broad band (i.e., multifrequency synthesis) images, thermal noise quickly integrates below foreground residuals. Reaching the cosmological signal should therefore be a matter of foreground mitigation and not the long time averages needed to measure the 3D power spectrum }\citep[e.g.][]{beardsley13,PoberNextGen}\DIFadd{. We check this hypothesis, asking how how }\DIFaddend much observation time is required to achieve the best foreground subtraction\DIFdelbegin \DIFdel{, with an eye towards the large survey areas required to mitigate the sample variance noise due to the uncorrelated component}\footnote{\DIFdel{Of course, the slight geometric correlations discussed in Sec. \ref{sec:pointsourcefgs} between radio and infrared fluxes introduce additional problems. However, we will show in Sec. \ref{sec:limitsandexptdesignstudy} that the leading order challenge in such intensity mapping correlation measurements is averaging down the sample variance noise in the cross spectrum due to the uncorrelated component radio and infrared foregrounds.}} %DIFAUXCMD
\addtocounter{footnote}{-1}%DIFAUXCMD
\DIFdel{of radio and infrared foregrounds in cross spectrum analyses.
In fact, while 3D 21}%DIFDELCMD < \,%%%
\DIFdel{cm intensity mapping measurements are limited by radio thermal noise and demand order thousand hour integrations to reveal the cosmological signal }%DIFDELCMD < \citep[e.g.][]{beardsley13,PoberNextGen}%%%
\DIFdel{, noise in broadband measurements is subdominant to foreground residuals after much shorter integration times. The MWA's $uv$ plane is essentially full after just 3 hours of rotation synthesis, and compounding days together serves only to reduce noise in 3D power spectra. 
}\DIFdelend \DIFaddbegin \DIFadd{.
%DIF > , with an eye towards the large survey areas required to mitigate the sample variance noise due to the uncorrelated component\footnote{Of course, the slight geometric correlations discussed in Sec. \ref{sec:pointsourcefgs} between radio and infrared fluxes introduce additional problems. However, we will show in Sec. \ref{sec:limitsandexptdesignstudy} that the leading order challenge in such intensity mapping correlation measurements is averaging down the sample variance noise in the cross spectrum due to the uncorrelated component radio and infrared foregrounds.} of radio and infrared foregrounds in cross spectrum analyses. 
%DIF > In fact, while 3D 21\,cm intensity mapping measurements are limited by radio thermal noise and demand order thousand hour integrations to reveal the cosmological signal \citep[e.g.][]{beardsley13,PoberNextGen}, noise in broadband measurements is subdominant to foreground residuals after much shorter integration times. The MWA's $uv$ plane is essentially full after just 3 hours of rotation synthesis, and compounding days together serves only to reduce noise in 3D power spectra. 
}\DIFaddend 
...
\end{equation}
summing over all the $\vec{\ell}$ values in each $\ell$ bin, where $N$ is the number of pixels of size $d\theta$ on each side of the square image. Note that $\ell=2\pi u$\DIFaddbegin \DIFadd{, where $u$ is the Fourier dual to angle from the field center assuming the small angle approximation}\DIFaddend . We estimate the thermal noise power spectrum by computing the power spectrum of the difference \DIFdelbegin \DIFdel{cube }\DIFdelend \DIFaddbegin \DIFadd{between the interleaved odd and even cubes discussed earlier, }\DIFaddend which contains only thermal noise.

\begin{figure}[h]
\centering
\includegraphics[width=3.5in]{res_pspec_of_100_obsids_with_diff_spacings_6amin_delta.pdf}
\caption[Raw, residual (post foreground subtraction), and noise power spectra of 185\,MHz broad band images from various data selections.]{Raw, residual (post foreground subtraction), and noise power spectra of 185\,MHz broad band images from various 3\,hour data selections (solid lines) and from the 32\,hour data selection used by  \citet{beardsley16} (black \DIFdelbeginFL \DIFdelFL{hashed}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{dashed}\DIFaddendFL ). The $uv$ plane is nearly filled after only 3\,hours, yet we find that spacing these $\sim100$ two-minute integrations over many independent nights reduces the foreground residuals by a factor of up to $\sim4$ in power. As a cross check on our analysis, we plot the $k_\parallel=0$ bin of the 3D power spectrum of \citet{beardsley16} converted to an angular power spectrum using Eqn. \ref{eqn:convertP3toP2} (\DIFdelbeginFL \DIFdelFL{cyan and }\DIFdelendFL magenta dashed).}
\label{fig:respspecspacingsstudy}
\end{figure}

We plot in Fig. \ref{fig:respspecspacingsstudy} the power spectra of 185\,MHz broad band images from  3\,hour data selections, spread over 1 (red solid), 5 (green solid), and 19 (blue solid) nights. We also make a broad band image of the same 32\,hour data set used by \citet{beardsley16} (black \DIFdelbegin \DIFdel{hashed}\DIFdelend \DIFaddbegin \DIFadd{dashed}\DIFaddend ). We plot the power spectra of the raw (pre foreground subtraction), residual (post foreground subtraction), and noise (difference between successive integrations) images out to $\ell=2600$, corresponding to a maximum baseline length of $\sim$700\,m. Beyond this, the $uv$ coverage becomes sparse, introducing artifacts in the application of gridding and uniform weighting, though a more sophisticated analysis could likely use these longer baselines. We cross-check our imaging and power spectrum analysis by comparing the  $k_\parallel=0$ bin of the 3D power spectrum of \citet{beardsley16} converted to an angular power spectrum using Eqn. \ref{eqn:convertP3toP2} (\DIFdelbegin \DIFdel{cyan and }\DIFdelend magenta dashed). 

We find that the raw power spectra of the different 3\,hour data sets agree with each other and with that of the 32\,hour data set, as expected given that foregrounds overwhelm thermal noise in a broad band image. Interestingly, the residual power spectrum decreases as the 3 hours are spread over more and more nights until it reaches the level of the deep 32 hour integration, a factor of $\sim4$ lower in power than in the single night analysis. These findings \DIFdelbegin \DIFdel{suggest that }\DIFdelend \DIFaddbegin \DIFadd{could be explained by }\DIFaddend slight ionosphere-related errors \DIFaddbegin \DIFadd{which }\DIFaddend limit the accuracy of each night's calibration, and thus, of its foreground subtraction. \DIFdelbegin \DIFdel{Thus while we use }\DIFdelend \DIFaddbegin \DIFadd{Further work would be needed to understand this effect in detail, but for now our conclusion is that }\DIFaddend the 32\,hour integration \DIFdelbegin \DIFdel{for convenience in this analysis, it is by no means necessary to use such a deep integration in a broad band analysis, especially when we will find later that survey speed is essential for such broad band correlation experiments}\DIFdelend \DIFaddbegin \DIFadd{has the best foreground subtraction, and we use this deep cube in our later analyses}\DIFaddend . Note that as expected, the thermal noise of the deep integration is \DIFdelbegin \DIFdel{a factor of $\sim10$ in power below that of }\DIFdelend \DIFaddbegin \DIFadd{10 times lower in power than }\DIFaddend the 3\,hour integrations\DIFdelbegin \DIFdel{, which are themselves at least a factor of $\sim100$ below the foreground residualsin these broad band images}\DIFdelend \DIFaddbegin \DIFadd{. Because these are band averaged images, even the 3}\,\DIFadd{hour thermal noise is at least 100 times lower than its foreground residuals}\DIFaddend .
...
Now we turn to application of this formalism to power spectrum estimation from our masked IR images. Later we will adapt it to estimation of the 21\,cm--IR cross spectrum. We take $\xb$ to be a vector of all IR coarse ($3.5'$) pixel values, with masked pixels set to zero. After gridding the high resolution images to reach this resolution, photon shot noise is negligible, and the image space covariance is the sum of the \DIFdelbegin \DIFdel{signal covariance }\DIFdelend \DIFaddbegin \DIFadd{sample variance }\DIFaddend $\Cb_\text{signal}$ and the masking covariance $\Cb_\text{mask}$. $\Cb_\text{mask}$ is a diagonal matrix with $\infty$ for masked pixels, and 0 otherwise. In practice, we replace $\infty$ with a number $10^7$ times larger than the largest eigenvalue of $\Cb_\text{signal}$, finding that the results are not sensitive to this parameter. The \DIFdelbegin \DIFdel{signal covariance }\DIFdelend \DIFaddbegin \DIFadd{sample variance }\DIFaddend is easily obtained by writing it in \DIFdelbegin \DIFdel{fourier space, }\DIFdelend \DIFaddbegin \DIFadd{Fourier space, $\Cb_\text{ft}$, }\DIFaddend where it is a diagonal matrix with a guess of the true power spectrum on the diagonal, then \DIFdelbegin \DIFdel{fourier }\DIFdelend \DIFaddbegin \DIFadd{Fourier }\DIFaddend transforming it into image space with \DIFdelbegin \DIFdel{fourier }\DIFdelend \DIFaddbegin \DIFadd{Fourier }\DIFaddend transform matrix $\mathcal{F}$. \DIFaddbegin \DIFadd{Putting these together gives
}\DIFaddend \begin{equation}
\label{eqn:covFTwithmask}
	\Cb = \mathcal{F}^\dagger\Cb_\text{ft}\mathcal{F}+\Cb_\text{mask}
\end{equation}
Note that $\mathcal{F}$ is an $N_\text{pix}\times N_\text{pix}$ matrix with elements $\mathcal{F}_{ij}=\exp(-i \vec{\theta}_i\cdot\vec{\ell}_j)$, where $i$ runs over all pixels and $j$ runs over all \DIFdelbegin \DIFdel{fourier }\DIFdelend \DIFaddbegin \DIFadd{Fourier }\DIFaddend cells. Said differently, a guess of the power spectrum is necessary to optimally downweight the sample variance noise on the estimated power spectrum. If the accuracy of the guess were in question, one could always iterate by feeding the estimated power spectrum back into the quadratic estimator, though in practice we find this is not necessary \DIFaddbegin \DIFadd{in this work}\DIFaddend .
...
Using this estimator, we calculate the power spectrum after each stage of masking and plot the mean spectrum over all four deep ATLAS fields in Fig. \ref{fig:bigfgmaskingstudypspecs} (left panel). \DIFdelbegin \DIFdel{We conservatively take the standard deviation of each bandpowers }\DIFdelend \DIFaddbegin \DIFadd{Instead of predicting the bandpower errors from the input covariances, we conservatively bootstrap the error bars by computing the standard deviation
%DIF > \footnote{In principle, the bandpowers are distributed with a $\chi^2$ distribution, and the sample standard deviation statistic is a biased estimator of the true variance at the $\sim10\%$ level, which we neglect in this work.}
 of each bandpower }\DIFaddend over the four fields\DIFdelbegin \DIFdel{as its error bar, due to sample variance}\DIFdelend . The power spectrum of all 850\,nm sources, masking only saturated regions, rises proportionally to $\ell$ (red dots), as expected for \DIFdelbegin \DIFdel{poisson }\DIFdelend \DIFaddbegin \DIFadd{Poisson }\DIFaddend source counts when the power spectrum is plotted as $\Delta=\sqrt{\ell^2C_\ell/2\pi}$. Masking sources out to $5\sigma$ removes two orders of magnitude in power (green dots), and masking out to $12\sigma$ and above 70\,kJy/sr over the background removes a factor of a few more in power (blue dots). Lastly, excluding modes with $|\ell_x|<200$ or $|\ell_y|<200$ gives our final 850\,nm anisotropy spectrum (black dots). We note that \DIFdelbegin \DIFdel{increasing any of the masking parameters introduced here in this section }\DIFdelend \DIFaddbegin \DIFadd{more stringent masking }\DIFaddend does not significantly alter \DIFdelbegin \DIFdel{these results. Increasing the masking radius around saturated pixels, for instance, results in masking of more coarse pixels, but removes negligible additional power from these residual spectra. After only }\DIFdelend \DIFaddbegin \DIFadd{this final result. After }\DIFaddend the first masking stage, we use a flat power spectrum in $C(\ell)$ as our guess \DIFdelbegin \DIFdel{for }\DIFdelend \DIFaddbegin \DIFadd{in }\DIFaddend the quadratic estimator formalism, and after the other three masking steps we use the 1.1\,$\mu$m power spectrum from \citet{zemcov14}.
...
\citet{zemcov14} argue that \DIFdelbegin \DIFdel{this }\DIFdelend \DIFaddbegin \DIFadd{their }\DIFaddend spectrum is limited by foregrounds at all $\ell$: by diffuse Galactic light (DGL) (i.e., dust) at $\ell\lesssim1000$, by intrahalo light (IHL) (cyan dashed line) at $\ell\sim1000$, and by galaxy number counts below the flux limit at larger $\ell$. ATLAS's $2''$ resolution is only a factor of 3 finer than CIBER's $7''$ resolution, so perhaps it is not surprising that the level of galaxy number counts is not appreciably different. The ATLAS points at $\ell>1000$ are in fact slightly above CIBER's, though the measurements were conducted over \DIFaddbegin \DIFadd{slightly }\DIFaddend different bands. \citet{mw15} demonstrate a dramatic \DIFdelbegin \DIFdel{improvements }\DIFdelend \DIFaddbegin \DIFadd{improvement }\DIFaddend in foreground reduction $\ell\gtrsim10^3$ in $10'$ Hubble mosaics with $0.1''$ resolution. Their power spectrum (red points) is a factor of $\sim10$ \DIFaddbegin \DIFadd{in amplitude }\DIFaddend below the previous IHL model, and their new fitting suggests that \DIFdelbegin \DIFdel{CIBER }\DIFdelend \DIFaddbegin \citet{zemcov14} \DIFaddend was in fact limited almost exclusively by DGL (red solid line). For comparison, we plot their \DIFdelbegin \DIFdel{new }\DIFdelend \DIFaddbegin \DIFadd{\textit{new} }\DIFaddend IHL model (red dashed) and EOR model (grey area). These results show that finer angular resolution can help reduce the foregrounds in the $\ell\sim10^2-10^4$ modes that can be cross correlated with 21\,cm EOR intensity mapping experiments. 
...
Similarly, \citet{PoberNextGen} simulate 21\,cm power spectra over a range of reionization scenarios \DIFaddbegin \DIFadd{using }\citet{21cmfast}\DIFadd{, }\DIFaddend with various values of ionizing efficiency ($\zeta$) (including the escape fraction), the minimum halo virial temperature ($T_\text{vir}$), and the ionizing photon mean free path in the IGM ($R_\text{mfp}$). Whether the signal at our redshift of interest ($z=7$) is large or not depends mostly on whether reionization is already largely finished by that time or not. So we take as our pessimistic model the $z=8$ power spectrum of the ($\zeta =31.5$, $T_\text{vir}=1.5\times10^4$\,K, $R_\text{mfp}=30$\,Mpc) scenario, whose reionization midpoint is $z=9.5$. We take as our optimistic model a late reionization scenario with $T_\text{vir}=3\times10^5$\,K (other parameters unchanged), whose reionization midpoint is $z=5.5$. 

From these power spectra and coherence functions, we generate approximate 21\,cm and Ly$\alpha$ cubes assuming \DIFdelbegin \DIFdel{gaussian statistics, a rough approximationgiven }\DIFdelend \DIFaddbegin \DIFadd{Gaussian statistics. This is an approximation, given that }\DIFaddend the 21\,cm field is expected to become \DIFdelbegin \DIFdel{somewhat less gaussian }\DIFdelend \DIFaddbegin \DIFadd{less and less Gaussian }\DIFaddend as reionization proceeds \citep{skew}\DIFaddbegin \DIFadd{, and more work is needed to understand this effect}\DIFaddend . The simulated cubes have (1\,Mpc)$^3$ resolution over a (218\,Mpc)$^3$ volume at $z=7$, corresponding to $\Delta z=0.6$ and $0.4'$ angular resolution. Our 21\,cm and Ly$\alpha$ cubes have units of mK and kJy/sr, respectively, and we average them in the line of sight direction to produce broad band images.

We plot the original 3D spherically averaged power spectra and coherence function as solid lines in Fig. \ref{fig:spectra3Dto2D}, and the computed 2D power spectra from the line-of-sight averaged cubes, as well as their coherence as dashed lines. The 3D \DIFaddbegin \DIFadd{and 2D }\DIFaddend power spectra are plotted as $\Delta(k)$ and $\Delta(\ell)$\DIFaddbegin \DIFadd{, respectively, }\DIFaddend as defined in Sec. \ref{sec:pspecdefs}. As expected, line of sight averaging tends to remove power on short spatial scales (compared to the line of sight depth of the cube), but it acts similarly on both cubes, so the coherence function is preserved. Note that the cross spectrum $\Delta_{12}$ is defined in terms of the coherence as $\Delta^2_{12}=c[\Delta^2_1\Delta_2^2]^{1/2}$ for both the 3D and 2D cases, and we use the same coherence function from \citet{Heneka2016} in the optimistic and pessimistic scenarios. \DIFaddbegin \DIFadd{These results show that 2D experiments can detect much of the 3D fluctuation power at $k<0.2$}\,\DIFadd{Mpc$^{-1}$, and motivate more complete and self consistent simulations of the 21}\,\DIFadd{cm and Ly$\alpha$ fields throughout the EOR over a range of optimistic and pessimistic scenarios.
}\DIFaddend 
...
\end{equation}
where $\Cb_{,\alpha}$ is the same matrix used in Sec. \ref{sec:resirfg}, \DIFaddbegin \DIFadd{and }\DIFaddend $\mathbf{x}_{21}$ and $\mathbf{x}_{\IR}$ are \DIFdelbegin \DIFdel{the }\DIFdelend \DIFaddbegin \DIFadd{column }\DIFaddend vectors of 21\,cm and IR pixel values. \DIFaddbegin \DIFadd{Observe that in this approximation, we model the radio covariance separately from the IR covariance. This separation is also ideal for our current study where we seek to \textit{characterize} any cross spectrum between the two, rather than \textit{model} a cross spectrum and \textit{downweight} by it.
}

\DIFaddend As before we use normalization $\Mb=\Fb^{-1/2}$ in $\pb=\Mb\qb$, and perform a final normalization using the peaks of the window functions $\Wb=\Mb\Fb$. We use the same IR covariance matrix given in Eqn. \ref{eqn:covFTwithmask}, and \DIFdelbegin \DIFdel{use }\DIFdelend \DIFaddbegin \DIFadd{model the radio covariance matrix as solely due to sample variance. We construct this covariance using the first term on the right side of Eqn. \ref{eqn:covFTwithmask}, taking the }\DIFaddend power spectrum of the residual MWA broadband images \DIFdelbegin \DIFdel{to construct the radio covariance matrix}\DIFdelend \DIFaddbegin \DIFadd{as our guess. We emphasize that in both cases, random noise is subdominant to the foreground residuals, so we do not include photon shot noise or thermal noise in these covariances}\DIFaddend . 

\begin{figure}[h]
\centering
\includegraphics[width=3.5in]{mwa_atlas_xspec_with_2Dsimtheory_and_2sigma_errors_6bins.pdf}
\caption[Measured cross spectrum between 185\,MHz and 850\,nm images after our best foreground subtraction and masking.]{Measured cross spectrum between 185\,MHz and 850\,nm images after our best foreground subtraction and masking\DIFdelbeginFL \DIFdelFL{(}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{. Our optimal quadratic estimator results are shown as }\DIFaddendFL red markers\DIFdelbeginFL \DIFdelFL{)}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{, while our FFT-based cross spectrum results are shown as grey markers}\DIFaddendFL . \DIFdelbeginFL \DIFdelFL{All }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Most }\DIFaddendFL are consistent with zero, and roughly half are positive (circles) and negative (triangles), as expected if there is no measured correlation. Error bars show $2\sigma$ uncertainties, and we take the tops of these error bars as upper limits on the cross spectrum of \DIFaddbeginFL \DIFaddFL{residual foregrounds of }\DIFaddendFL 21\,cm--Ly$\alpha$ emission from the EOR \DIFaddbeginFL \DIFaddFL{at $z\sim7$}\DIFaddendFL . We achieve an upper limit of $\Delta^2<181$\,$(\text{kJy/sr}\cdot \text{mK})$ (95\%) at $\ell\sim800$. We also plot the radio--infrared foreground cross spectrum that a 1\% flux correlation would produce (green line), and find that it is below the sensitivity of our MWA--ATLAS experiment\DIFaddbeginFL \DIFaddFL{, which is  limited by the sample variance noise of uncorrelated foregrounds}\DIFaddendFL .}
\label{fig:resxspec}
\end{figure}

We apply this formalism to each of the four $4^\circ$ deep ATLAS fields shown in Fig. \ref{fig:surveyoverview}, pairing each IR image with the overlapping region of the MWA image cropped from the naturally weighted image. We crop the image space synthesized beam over the same field of view, \DIFaddbegin \DIFadd{then }\DIFaddend use it to apply uniform weighting to the cropped MWA image using Eqn. \ref{eqn:uniformweighting}. In Fig. \ref{fig:resxspec} we plot the resulting cross spectrum (red markers) averaged over all four fields with $2\sigma$ error bars. \DIFdelbegin \DIFdel{All }\DIFdelend \DIFaddbegin \DIFadd{Most }\DIFaddend are consistent with zero, and roughly half the estimated bandpowers are negative (triangles) and positive (circles), as expected if there is no measured correlation. Our bins are evenly spaced in $\log \ell$, and it is beneficial to overlap them slightly since our normalization matrix $M\sim F^{-1/2}$ ensures bin errors are always uncorrelated. We take the tops of the error bars as 95\% upper limits on the \DIFdelbegin \DIFdel{cosmological }\DIFdelend cross spectrum of \DIFaddbegin \DIFadd{residual foregrounds of  }\DIFaddend 21\,cm and Ly$\alpha$ emission from the EOR, achieving a tightest upper limit of $\Delta^2<181$\,$(\text{kJy/sr}\cdot \text{mK})$ (95\%) at $\ell\sim800$. For comparison, we plot optimistic (black solid) and pessimistic (black dashed) model cross spectra as discussed in the previous section.

\DIFaddbegin \DIFadd{We check these quadratic estimator results (red points) against FFT-based power spectrum results on the same images (grey points). In fact the two spectra are quite similar. In most bins the quadratic estimator limits are lower, but are not significantly closer to the fiducial 1}\% \DIFadd{radio/IR foreground correlation. To understand why the FFT results are only slightly worse, consider that after our IR foreground masking, only $\sim$5}\% \DIFadd{of coarse pixels end up masked. With different masking parameters more or fewer coarse pixels would get masked, in some cases necessitating the quadratic estimator to deal with large masked regions. But with the best masking parameters we settled on, the improvement is modest. 
}

 
\DIFaddend Also in Fig. \ref{fig:resxspec} we plot the radio--infrared foreground cross spectrum that a 1\% flux correlation would produce (green line), as motivated by our results in Sections \ref{sec:fluxcorsims} and \ref{sec:catcorrelations}. Such a slight geometric flux correlation is thus still predicted to be slightly below the sensitivity of our MWA--ATLAS experiment, but is it significant for other classes of experiments? To study this we predict for a range of current and future radio--IR surveys both the foreground sample variance noise and the foreground cross spectrum for a slight geometric correlation. 
...
\item \textit{\DIFdelbegin \DIFdel{Hubble }\DIFdelend \DIFaddbegin \DIFadd{WFIRST }\DIFaddend mosaic}. \citet{mw15} have demonstrated high fidelity mosaicing using the technique of \citet{fixen00}, producing $10'$ wide mosaics from the $\sim2'$ Hubble field of view. \DIFdelbegin \DIFdel{We }\DIFdelend \DIFaddbegin \DIFadd{Along these lines, we }\DIFaddend assume that a $4^\circ$ \DIFdelbegin \DIFdel{Hubble }\DIFdelend \DIFaddbegin \DIFadd{WFIRST }\DIFaddend field can be used through some combination of mosaicing (making larger IR images) and tiling (\DIFdelbegin \DIFdel{calculating }\DIFdelend \DIFaddbegin \DIFadd{averaging }\DIFaddend the cross spectrum \DIFdelbegin \DIFdel{between each of many small Hubble fieldsand the radio image, then averaging the results). }\DIFdelend \DIFaddbegin \DIFadd{over many small fields). The instantaneous field of view of WFIRST is roughly 100 times that of Hubble with comparable resolution. }\DIFaddend Motivated by the results of \citet{mw15}, we assume \DIFdelbegin \DIFdel{that the fine resolution of Hubble permits removal of IR foregrounds by a factor of $\sim100$}\DIFdelend \DIFaddbegin \DIFadd{a 100$\times$ improvement in IR foreground removal over our ATLAS analysis}\DIFaddend .
\item \textit{DES mosaic}. Along these lines, we assume a similar analysis can be conducted using the Dark Energy Survey \DIFdelbegin %DIFDELCMD < \citet{des16} %%%
\DIFdelend \DIFaddbegin \citep{des16} \DIFaddend over a field of view which is 10$\times$ larger on a side, due to the instrument's correspondingly larger field of view. We assume the same improvement in foreground removal as in the Hubble mosaic discussed previously.
\end{itemize}

Neglecting the small \DIFaddbegin \DIFadd{geometric foreground }\DIFaddend correlation, the \DIFaddbegin \DIFadd{foreground }\DIFaddend sample variance noise due to uncorrelated foregrounds is
\begin{eqnarray}
...
LOFAR reaches within a factor of a few in power of the optimistic EOR cross spectrum model when correlated against the Hubble (red triangle) or DES (red square) mosaics, and the SKA coupled with the same IR surveys achieves a \DIFdelbegin \DIFdel{convincing }\DIFdelend \DIFaddbegin \DIFadd{near }\DIFaddend detection of the optimistic model (white square and white triangle). None of the experiments \DIFdelbegin \DIFdel{considered can reach }\DIFdelend \DIFaddbegin \DIFadd{reaches }\DIFaddend the pessimistic model, but \DIFdelbegin \DIFdel{excluding the optimistic model already begins }\DIFdelend \DIFaddbegin \DIFadd{beginning to probe optimistic models already starts }\DIFaddend to exclude late reionization scenarios, and performing the same correlation experiment at higher redshifts can likely give more leverage on earlier ones. 

Interestingly, we note that virtually all the intermediate experiments between this work and the ultimate detection will be limited by the geometric foreground correlations. Motivated by our results in Sec. \ref{sec:catcorrelations}, we have assumed here that the coherence remains at the percent-level irrespective of mask depth, though more work is needed to model this effect more completely and self-consistently. \DIFdelbegin \DIFdel{Luckily, the negative sign of the predicted }\DIFdelend \DIFaddbegin \DIFadd{In any case, this geometric foreground correlation appears to be strictly positive, while the predicted correlation of }\DIFaddend 21\,cm--Ly$\alpha$ \DIFdelbegin \DIFdel{correlation }\DIFdelend from the EOR \DIFdelbegin \DIFdel{should clearly distinguish itself from this foreground effect, meaning there is still hope to make the measurements simulated by }%DIFDELCMD < \citet{mao14,StarsAndReionization}%%%
\DIFdelend \DIFaddbegin \DIFadd{is negative, giving us a test of whether foregrounds remain in the data}\DIFaddend .
...
In the first part of this paper we searched for correlations between radio and infrared \DIFdelbegin \DIFdel{catalogs fluxes . }\DIFdelend \DIFaddbegin \DIFadd{catalog fluxes (i.e., point sources). }\DIFaddend We began with the 185\,MHz MWA catalog and the 4.5\,$\mu$m WISE catalog; any foreground correlation between these bands would limit 21\.cm--H$\alpha$ correlation analyses at $z\sim7$. We detect a \DIFdelbegin \DIFdel{$\sim5\%$ }\DIFdelend \DIFaddbegin \DIFadd{few }\DIFaddend correlation at $>6\sigma$ significance after masking 4.5\,$\mu$m sources down to \DIFdelbegin \DIFdel{1}%DIFDELCMD < \,%%%
\DIFdel{mJy}\DIFdelend \DIFaddbegin \DIFadd{18.25 mag}\DIFaddend , which corresponds to the flux below which extragalactic sources dominate the catalog. We reproduce this observed 185\,MHz--4.5\,$\mu$m correlation in simulations, confirming that it is sourced by starforming galaxies rather than AGN. The narrow radio and infrared luminosity functions of the former make distance a much stronger effect than for AGN in \DIFdelbegin \DIFdel{calculating }\DIFdelend \DIFaddbegin \DIFadd{deriving }\DIFaddend fluxes from luminosities. 

We then performed 850\,nm observations of the MWA field using the ATLAS telescope, and searched for correlations between 185\,MHz and 850\,nm catalog fluxes in MWA and ATLAS catalogs. Any correlation between these bands would limit 21\,cm--Ly$\alpha$ analyses. We observed a \DIFdelbegin \DIFdel{weak }\DIFdelend \DIFaddbegin \DIFadd{marginal }\DIFaddend correlation at the $\sim3\sigma$ level which grew \DIFaddbegin \DIFadd{slightly }\DIFaddend stronger towards our deepest 850\,nm mask depth of 0.1\,mJy. This is consistent with our finding from Sloan Digital Sky Survey data that at 850\,nm, stars still dominate source counts above this flux. Deeper near infrared studies are needed to study how these correlations depend on mask depth to quantify what level of foreground removal is required to mitigate them. For now, we assume that radio--infrared flux correlations are at the percent-level for the purpose of weighing foreground flux correlations versus foreground sample variance noise in our experimental design study.

In the second part of this paper we analyzed the residual 185\,MHz and 850\,nm foregrounds in MWA and ATLAS images after subtracting radio sources and masking infrared sources. We computed power spectra of the band averaged MWA cubes and found they agree with the $k_\parallel=0$ bin of the 3D power spectra of \citet{beardsley16} after conversion from 3D to 2D units. Despite the fact that the MWA image is not thermal noise-limited, we find that foreground subtraction improves significantly (by a factor of 2 in power) when the \DIFaddbegin \DIFadd{same number of }\DIFaddend observations are spread over two weeks instead of \DIFaddbegin \DIFadd{clustered within }\DIFaddend a single night, consistent with ionosphere-induced calibration errors. \DIFdelbegin \DIFdel{This implies that if multiple fields are to be observed, the }\DIFdelend \DIFaddbegin \DIFadd{If the ionosphere is indeed the cause, then the implication is that is that }\DIFaddend observing time should be rotated between \DIFdelbegin \DIFdel{them }\DIFdelend \DIFaddbegin \DIFadd{multiple fields }\DIFaddend on a nightly cadence.

We then used the optimal quadratic estimator of\DIFaddbegin \DIFadd{+ }\DIFaddend \citet{Maxpowerspeclossless} to compute the power spectrum of our 850\,nm ATLAS images after masking sources at $2''$ resolution. These results agree well over $300<\ell<4000$ with the $1.1$\,$\mu$m power spectrum measured by \citep{zemcov14} using CIBER, a sounding rocket with $7''$ resolution and $\sim1^\circ$ field of view. Our larger field of view permits significantly improved precision at $\ell<1000$, and while our slightly increased resolution \textit{should} permit better masking, the lack of foreground reduction indicates that the power spectrum has hit a floor at these angular scales. \citet{mw15} show that mild improvement is possible using the Hubble's significantly improved $0.1''$ resolution, but argue that further improvement at these angular scales is stymied by Galactic dust. They demonstrate that significant improvement is \DIFdelbegin \DIFdel{only }\DIFdelend possible at larger $\ell$, \DIFdelbegin \DIFdel{angular scales }\DIFdelend \DIFaddbegin \DIFadd{though these scales are }\DIFaddend largely inaccessible to 21\,cm observatories focusing on \DIFdelbegin \DIFdel{power spectrum estimation such as }\DIFdelend \DIFaddbegin \DIFadd{EOR power spectrum measurements (e.g., }\DIFaddend PAPER, the MWA, and HERA\DIFaddbegin \DIFadd{)}\DIFaddend . Taking advantage of these infrared foreground reductions \DIFdelbegin \DIFdel{to reduce foreground noise and correlations in 21}%DIFDELCMD < \,%%%
\DIFdel{cm--Ly$\alpha$ correlation experiments }\DIFdelend will require the higher resolution images of  LOFAR and SKA-LOW.

Turning to cross spectrum measurements, we simulate the \DIFdelbegin \DIFdel{signal loss in 2D versus }\DIFdelend \DIFaddbegin \DIFadd{loss of signal in to band averaging from }\DIFaddend 3D \DIFdelbegin \DIFdel{EOR intensity mapping experiments}\DIFdelend \DIFaddbegin \DIFadd{to 2D maps}\DIFaddend . We find that 2D experiments can recover \DIFdelbegin \DIFdel{of order 100}%DIFDELCMD < \% %%%
\DIFdelend \DIFaddbegin \DIFadd{much of }\DIFaddend the signal at $k<0.2$\,Mpc$^{-1}$, but that power on shorter length scales  suppressed by a factor of $10-10^2$ in power due to averaging out of of $k_\parallel>0$ modes. 

Finally, we used our foreground subtracted and masked MWA and ATLAS images to set the first limits on the \DIFaddbegin \DIFadd{cross spectrum of residual foregrounds of }\DIFaddend 21\,\DIFdelbegin \DIFdel{cm--Ly}\DIFdelend \DIFaddbegin \DIFadd{cm and Ly}\DIFaddend $\alpha$ \DIFdelbegin \DIFdel{cross spectrum }\DIFdelend \DIFaddbegin \DIFadd{emission  }\DIFaddend from $z\sim7$. We adapted the optimal quadratic estimator to the cross spectrum case to properly account for both \DIFdelbegin \DIFdel{the }\DIFdelend non-uniform \DIFaddbegin \DIFadd{radio }\DIFaddend $uv$ sampling \DIFdelbegin \DIFdel{of radio interferometers and the non-uniform image  sampling of masked infrared images}\DIFdelend \DIFaddbegin \DIFadd{and infrared image space masking}\DIFaddend . Our results are consistent with zero correlation, and our strictest upper limit on the \DIFdelbegin \DIFdel{EOR }\DIFdelend \DIFaddbegin \DIFadd{residual foreground }\DIFaddend cross spectrum is $\Delta^2<181$\,$(\text{kJy/sr}\cdot \text{mK})$ (95\%) at $\ell\sim800$.

A percent-level correlation between radio and infrared foreground fluxes, of the sort suggested by our catalog correlation analyses, remains below this upper limit, but will be crucial for future experiments. We weigh the impact of a percent-level radio--infrared foreground correlation against the sample variance noise due to their uncorrelated part for several possible future experiments. The simplest improvement we consider is increasing the ATLAS survey area by a factor of $\sim10$ and subtracting radio fluxes below the MWA's confusion limit using the GMRT catalog. We predict that the sensitivity boost of these improvements should reveal the cross spectrum floor due to the percent-level geometric flux correlations. Pushing down this floor requires foreground reduction \DIFdelbegin \DIFdel{due }\DIFdelend \DIFaddbegin \DIFadd{using }\DIFaddend to higher resolution radio surveys such as LOFAR and SKA-LOW and infrared surveys such as Hubble and the Dark Energy Survey, though future work is needed to better understand these geometric flux correlations at very deep flux cuts.

We conclude that \DIFdelbegin \DIFdel{detecting }\DIFdelend \DIFaddbegin \DIFadd{detection of }\DIFaddend the predicted EOR anticorrelation between redshifted 21\,cm and Ly$\alpha$ emission in 2D (i.e., broad band) images is \DIFdelbegin \DIFdel{close to being }\DIFdelend \DIFaddbegin \DIFadd{challenging, but }\DIFaddend within reach of \DIFdelbegin \DIFdel{current surveys, and future analyses using SKA-LOW can begin to significantly constrain EOR parameter space.
These }\DIFdelend \DIFaddbegin \DIFadd{future surveys.
}

\DIFadd{In the near term, by probing correlation properties of radio/infrared foregrounds, these }\DIFaddend 2D experiments will be valuable complements to future 3D correlation analyses using infrared cubes \DIFdelbegin \DIFdel{measured using }\DIFdelend \DIFaddbegin \DIFadd{from }\DIFaddend the proposed SPHEREx and Cosmic Dawn Intensity Mapper telescopes. These 3D surveys exchange foreground challenges for sensitivity and cost challenges, but will eventually probe the short spatial scales inaccessible to 2D surveys. The decade of direction observation of the EOR is upon us, and correlation experiments will help us move from the era of detection to the era of astrophysics.
...
%DIF < \bibliography{xcor_paper_new}
\DIFdelbegin %DIFDELCMD < 

%DIFDELCMD < \begin{thebibliography}{124}
%DIFDELCMD < \expandafter\ifx\csname %%%
\DIFdel{natexlab}%DIFDELCMD < \endcsname\relax\def\natexlab%%%
\DIFdel{#1}%DIFDELCMD < {%%%
\DIFdel{#1}%DIFDELCMD < }\fi
%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Ali} {et~al.}(2015){Ali}, {Parsons}, {Zheng}, {Pober}, {Liu},
%DIFDELCMD <   {Aguirre}, {Bradley}, {Bernardi}, {Carilli}, {Cheng}, {DeBoer}, {Dexter},
%DIFDELCMD <   {Grobbelaar}, {Horrell}, {Jacobs}, {Klima}, {MacMahon}, {Maree}, {Moore},
%DIFDELCMD <   {Razavi}, {Stefan}, {Walbrugh}, \& {Walker}}]{ali15}
%DIFDELCMD < {%%%
\DIFdel{Ali}%DIFDELCMD < }%%%
\DIFdel{, Z.~S., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2015, ApJ, 809, 61
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Alvarez} {et~al.}(2012){Alvarez}, {Finlator}, \&
%DIFDELCMD <   {Trenti}}]{Alvarez2012}
%DIFDELCMD < {%%%
\DIFdel{Alvarez}%DIFDELCMD < }%%%
\DIFdel{, M.~A., }%DIFDELCMD < {%%%
\DIFdel{Finlator}%DIFDELCMD < }%%%
\DIFdel{, K., }%DIFDELCMD < \& {%%%
\DIFdel{Trenti}%DIFDELCMD < }%%%
\DIFdel{, M. 2012, }%DIFDELCMD < \apjl%%%
\DIFdel{, 759, L38
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Amor{\'{\i}}n} {et~al.}(2017){Amor{\'{\i}}n}, {Fontana},
%DIFDELCMD <   {P{\'e}rez-Montero}, {Castellano}, {Guaita}, {Grazian}, {F{\`e}vre},
%DIFDELCMD <   {Ribeiro}, {Schaerer}, {Tasca}, {Thomas}, {Bardelli}, {Cassar{\`a}},
%DIFDELCMD <   {Cassata}, {Cimatti}, {Contini}, {Barros}, {Garilli}, {Giavalisco}, {Hathi},
%DIFDELCMD <   {Koekemoer}, {Le Brun}, {Lemaux}, {Maccagni}, {Pentericci}, {Pforr}, {Talia},
%DIFDELCMD <   {Tresse}, {Vanzella}, {Vergani}, {Zamorani}, {Zucca}, \&
%DIFDELCMD <   {Merlin}}]{primevaltwins}
%DIFDELCMD < {%%%
\DIFdel{Amor}%DIFDELCMD < {\'{\i}}%%%
\DIFdel{n}%DIFDELCMD < }%%%
\DIFdel{, R., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
...
%DIFDELCMD < \bibitem[{{Atek} {et~al.}(2015){Atek}, {Richard}, {Jauzac}, {Kneib},
%DIFDELCMD <   {Natarajan}, {Limousin}, {Schaerer}, {Jullo}, {Ebeling}, {Egami}, \&
%DIFDELCMD <   {Clement}}]{Atek2015}
%DIFDELCMD < {%%%
\DIFdel{Atek}%DIFDELCMD < }%%%
\DIFdel{, H., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2015, }%DIFDELCMD < \apj%%%
\DIFdel{, 814, 69
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Beardsley} {et~al.}(2015){Beardsley}, {Morales}, {Lidz}, {Malloy},
%DIFDELCMD <   \& {Sutter}}]{beardsley15}
%DIFDELCMD < {%%%
\DIFdel{Beardsley}%DIFDELCMD < }%%%
\DIFdel{, A.~P., }%DIFDELCMD < {%%%
\DIFdel{Morales}%DIFDELCMD < }%%%
\DIFdel{, M.~F., }%DIFDELCMD < {%%%
\DIFdel{Lidz}%DIFDELCMD < }%%%
\DIFdel{, A., }%DIFDELCMD < {%%%
\DIFdel{Malloy}%DIFDELCMD < }%%%
\DIFdel{, M., }%DIFDELCMD < \& {%%%
\DIFdel{Sutter}%DIFDELCMD < }%%%
\DIFdel{,
  P.~M. 2015, }%DIFDELCMD < \apj%%%
\DIFdel{, 800, 128
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Beardsley} {et~al.}(2013){Beardsley}, {Hazelton}, {Morales},
%DIFDELCMD <   {Arcus}, {Barnes}, {Bernardi}, {Bowman}, {Briggs}, {Bunton}, {Cappallo},
%DIFDELCMD <   {Corey}, {Deshpande}, {deSouza}, {Emrich}, {Gaensler}, {Goeke}, {Greenhill},
%DIFDELCMD <   {Herne}, {Hewitt}, {Johnston-Hollitt}, {Kaplan}, {Kasper}, {Kincaid},
%DIFDELCMD <   {Koenig}, {Kratzenberg}, {Lonsdale}, {Lynch}, {McWhirter}, {Mitchell},
%DIFDELCMD <   {Morgan}, {Oberoi}, {Ord}, {Pathikulangara}, {Prabu}, {Remillard}, {Rogers},
%DIFDELCMD <   {Roshi}, {Salah}, {Sault}, {Udaya}, {Srivani}, {Stevens}, {Subrahmanyan},
%DIFDELCMD <   {Tingay}, {Wayth}, {Waterson}, {Webster}, {Whitney}, {Williams}, {Williams},
%DIFDELCMD <   \& {Wyithe}}]{beardsley13}
%DIFDELCMD < {%%%
\DIFdel{Beardsley}%DIFDELCMD < }%%%
\DIFdel{, A.~P., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
...
%DIFDELCMD < \bibitem[{{Beardsley} {et~al.}(2016){Beardsley}, {Hazelton}, {Sullivan},
%DIFDELCMD <   {Carroll}, {Barry}, {Rahimi}, {Pindor}, {Trott}, {Line}, {Jacobs}, {Morales},
%DIFDELCMD <   {Pober}, {Bernardi}, {Bowman}, {Busch}, {Briggs}, {Cappallo}, {Corey}, {de
%DIFDELCMD <   Oliveira-Costa}, {Dillon}, {Emrich}, {Ewall-Wice}, {Feng}, {Gaensler},
%DIFDELCMD <   {Goeke}, {Greenhill}, {Hewitt}, {Hurley-Walker}, {Johnston-Hollitt},
%DIFDELCMD <   {Kaplan}, {Kasper}, {Kim}, {Kratzenberg}, {Lenc}, {Loeb}, {Lonsdale},
%DIFDELCMD <   {Lynch}, {McKinley}, {McWhirter}, {Mitchell}, {Morgan}, {Neben},
%DIFDELCMD <   {Thyagarajan}, {Oberoi}, {Offringa}, {Ord}, {Paul}, {Prabu}, {Procopio},
%DIFDELCMD <   {Riding}, {Rogers}, {Roshi}, {Udaya Shankar}, {Sethi}, {Srivani},
%DIFDELCMD <   {Subrahmanyan}, {Tegmark}, {Tingay}, {Waterson}, {Wayth}, {Webster},
%DIFDELCMD <   {Whitney}, {Williams}, {Williams}, {Wu}, \& {Wyithe}}]{beardsley16}
%DIFDELCMD < %%%
\DIFdel{---. 2016, ArXiv e-prints
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Bernard} {et~al.}(2016){Bernard}, {Carrasco}, {Trenti}, {Oesch},
%DIFDELCMD <   {Wu}, {Bradley}, {Schmidt}, {Bouwens}, {Calvi}, {Mason}, {Stiavelli}, \&
%DIFDELCMD <   {Treu}}]{Bernard2016}
%DIFDELCMD < {%%%
\DIFdel{Bernard}%DIFDELCMD < }%%%
\DIFdel{, S.~R., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2016, }%DIFDELCMD < \apj%%%
\DIFdel{, 827, 76
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Bertin} \& {Arnouts}(1996)}]{sextractor}
%DIFDELCMD < {%%%
\DIFdel{Bertin}%DIFDELCMD < }%%%
\DIFdel{, E., }%DIFDELCMD < \& {%%%
\DIFdel{Arnouts}%DIFDELCMD < }%%%
\DIFdel{, S. 1996, }%DIFDELCMD < \aaps%%%
\DIFdel{, 117, 393
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Bertin} {et~al.}(2002){Bertin}, {Mellier}, {Radovich}, {Missonnier},
%DIFDELCMD <   {Didelon}, \& {Morin}}]{swarp}
%DIFDELCMD < {%%%
\DIFdel{Bertin}%DIFDELCMD < }%%%
\DIFdel{, E., }%DIFDELCMD < {%%%
\DIFdel{Mellier}%DIFDELCMD < }%%%
\DIFdel{, Y., }%DIFDELCMD < {%%%
\DIFdel{Radovich}%DIFDELCMD < }%%%
\DIFdel{, M., }%DIFDELCMD < {%%%
\DIFdel{Missonnier}%DIFDELCMD < }%%%
\DIFdel{, G., }%DIFDELCMD < {%%%
\DIFdel{Didelon}%DIFDELCMD < }%%%
\DIFdel{, P.,
  }%DIFDELCMD < \& {%%%
\DIFdel{Morin}%DIFDELCMD < }%%%
\DIFdel{, B. 2002, in Astronomical Society of the Pacific Conference
  ...
  D.~A. }%DIFDELCMD < {%%%
\DIFdel{Bohlender}%DIFDELCMD < }%%%
\DIFdel{, D.~}%DIFDELCMD < {%%%
\DIFdel{Durand}%DIFDELCMD < }%%%
\DIFdel{, }%DIFDELCMD < \& %%%
\DIFdel{T.~H. }%DIFDELCMD < {%%%
\DIFdel{Handley}%DIFDELCMD < }%%%
\DIFdel{, 228
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{bij~de Vaate {et~al.}(2011)bij~de Vaate, de~Lera~Acedo, Virone,
%DIFDELCMD <   Jiwani, Razavi, Perini, Zarb-Adami, Monari, Padhi, Addamo, Peverini,
%DIFDELCMD <   Montebugnoli, Gunst, Hall, Faulkner, \& van Ardenne}]{ska3}
%DIFDELCMD < %%%
\DIFdel{bij~de Vaate, J., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2011, in General Assembly and Scientific Symposium,
  2011 XXXth URSI, 1--4
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Bouwens}(2016)}]{Bouwens2016b}
%DIFDELCMD < {%%%
\DIFdel{Bouwens}%DIFDELCMD < }%%%
\DIFdel{, R. 2016, in Astrophysics and Space Science Library, Vol. 423,
  ...
  A.~}%DIFDELCMD < {%%%
\DIFdel{Mesinger}%DIFDELCMD < }%%%
\DIFdel{, 111
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Bouwens} {et~al.}(2016{\natexlab{a}}){Bouwens}, {Oesch},
%DIFDELCMD <   {Illingworth}, {Ellis}, \& {Stefanon}}]{Bouwens2016}
%DIFDELCMD < {%%%
\DIFdel{Bouwens}%DIFDELCMD < }%%%
\DIFdel{, R.~J., }%DIFDELCMD < {%%%
\DIFdel{Oesch}%DIFDELCMD < }%%%
\DIFdel{, P.~A., }%DIFDELCMD < {%%%
\DIFdel{Illingworth}%DIFDELCMD < }%%%
\DIFdel{, G.~D., }%DIFDELCMD < {%%%
\DIFdel{Ellis}%DIFDELCMD < }%%%
\DIFdel{, R.~S., }%DIFDELCMD < \&
%DIFDELCMD <   {%%%
\DIFdel{Stefanon}%DIFDELCMD < }%%%
\DIFdel{, M. 2016}%DIFDELCMD < {\natexlab{a}}%%%
\DIFdel{, ArXiv e-prints
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Bouwens} {et~al.}(2011){Bouwens}, {Illingworth}, {Oesch},
%DIFDELCMD <   {Labb{\'e}}, {Trenti}, {van Dokkum}, {Franx}, {Stiavelli}, {Carollo},
%DIFDELCMD <   {Magee}, \& {Gonzalez}}]{Bouwens2011}
%DIFDELCMD < {%%%
\DIFdel{Bouwens}%DIFDELCMD < }%%%
\DIFdel{, R.~J., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2011, }%DIFDELCMD < \apj%%%
\DIFdel{, 737, 90
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Bouwens} {et~al.}(2014){Bouwens}, {Illingworth}, {Oesch},
%DIFDELCMD <   {Labb{\'e}}, {van Dokkum}, {Trenti}, {Franx}, {Smit}, {Gonzalez}, \&
%DIFDELCMD <   {Magee}}]{Bouwens2013}
%DIFDELCMD < %%%
\DIFdel{---. 2014, }%DIFDELCMD < \apj%%%
\DIFdel{, 793, 115
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Bouwens} {et~al.}(2015){Bouwens}, {Illingworth}, {Oesch}, {Trenti},
%DIFDELCMD <   {Labb{\'e}}, {Bradley}, {Carollo}, {van Dokkum}, {Gonzalez}, {Holwerda},
%DIFDELCMD <   {Franx}, {Spitler}, {Smit}, \& {Magee}}]{Bouwens2015}
%DIFDELCMD < %%%
\DIFdel{---. 2015, }%DIFDELCMD < \apj%%%
\DIFdel{, 803, 34
}%DIFDELCMD < 
...
%DIFDELCMD <   {Labb{\'e}}, {Illingworth}, {Fazio}, {Coe}, {Holwerda}, {Smit}, {Stefanon},
%DIFDELCMD <   {van Dokkum}, {Trenti}, {Ashby}, {Huang}, {Spitler}, {Straatman}, {Bradley},
%DIFDELCMD <   \& {Magee}}]{Bouwens2016a}
%DIFDELCMD < %%%
\DIFdel{---. 2016}%DIFDELCMD < {\natexlab{b}}%%%
\DIFdel{, }%DIFDELCMD < \apj%%%
\DIFdel{, 830, 67
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Bowler} {et~al.}(2017){Bowler}, {Dunlop}, {McLure}, \&
%DIFDELCMD <   {McLeod}}]{Bowler2017}
%DIFDELCMD < {%%%
\DIFdel{Bowler}%DIFDELCMD < }%%%
\DIFdel{, R.~A.~A., }%DIFDELCMD < {%%%
\DIFdel{Dunlop}%DIFDELCMD < }%%%
\DIFdel{, J.~S., }%DIFDELCMD < {%%%
\DIFdel{McLure}%DIFDELCMD < }%%%
\DIFdel{, R.~J., }%DIFDELCMD < \& {%%%
\DIFdel{McLeod}%DIFDELCMD < }%%%
\DIFdel{, D.~J. 2017,
  }%DIFDELCMD < \mnras%%%
\DIFdel{, 466, 3612
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Bowler} {et~al.}(2015){Bowler}, {Dunlop}, {McLure}, {McCracken},
%DIFDELCMD <   {Milvang-Jensen}, {Furusawa}, {Taniguchi}, {Le F{\`e}vre}, {Fynbo}, {Jarvis},
%DIFDELCMD <   \& {H{\"a}u{\ss}ler}}]{Bowler2015}
%DIFDELCMD < {%%%
\DIFdel{Bowler}%DIFDELCMD < }%%%
\DIFdel{, R.~A.~A., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2015, }%DIFDELCMD < \mnras%%%
\DIFdel{, 452, 1817
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Bowman} {et~al.}(2013){Bowman}, {Cairns}, {Kaplan}, {Murphy},
%DIFDELCMD <   {Oberoi}, {Staveley-Smith}, {Arcus}, {Barnes}, {Bernardi}, {Briggs}, {Brown},
%DIFDELCMD <   {Bunton}, {Burgasser}, {Cappallo}, {Chatterjee}, {Corey}, {Coster},
%DIFDELCMD <   {Deshpande}, {deSouza}, {Emrich}, {Erickson}, {Goeke}, {Gaensler},
%DIFDELCMD <   {Greenhill}, {Harvey-Smith}, {Hazelton}, {Herne}, {Hewitt},
%DIFDELCMD <   {Johnston-Hollitt}, {Kasper}, {Kincaid}, {Koenig}, {Kratzenberg}, {Lonsdale},
%DIFDELCMD <   {Lynch}, {Matthews}, {McWhirter}, {Mitchell}, {Morales}, {Morgan}, {Ord},
%DIFDELCMD <   {Pathikulangara}, {Prabu}, {Remillard}, {Robishaw}, {Rogers}, {Roshi},
%DIFDELCMD <   {Salah}, {Sault}, {Shankar}, {Srivani}, {Stevens}, {Subrahmanyan}, {Tingay},
%DIFDELCMD <   {Wayth}, {Waterson}, {Webster}, {Whitney}, {Williams}, {Williams}, \&
%DIFDELCMD <   {Wyithe}}]{mwascience}
%DIFDELCMD < {%%%
\DIFdel{Bowman}%DIFDELCMD < }%%%
\DIFdel{, J.~D., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2013, PASA, 30, e031
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Bradley} {et~al.}(2012){Bradley}, {Trenti}, {Oesch}, {Stiavelli},
%DIFDELCMD <   {Treu}, {Bouwens}, {Shull}, {Holwerda}, \& {Pirzkal}}]{Bradley2012}
%DIFDELCMD < {%%%
\DIFdel{Bradley}%DIFDELCMD < }%%%
\DIFdel{, L.~D., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2012, }%DIFDELCMD < \apj%%%
\DIFdel{, 760, 108
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Calvi} {et~al.}(2016){Calvi}, {Trenti}, {Stiavelli}, {Oesch},
%DIFDELCMD <   {Bradley}, {Schmidt}, {Coe}, {Brammer}, {Bernard}, {Bouwens}, {Carrasco},
%DIFDELCMD <   {Carollo}, {Holwerda}, {MacKenty}, {Mason}, {Shull}, \& {Treu}}]{Calvi}
%DIFDELCMD < {%%%
\DIFdel{Calvi}%DIFDELCMD < }%%%
\DIFdel{, V., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2016, }%DIFDELCMD < \apj%%%
\DIFdel{, 817, 120
...
%DIFDELCMD < \bibitem[{{Carroll} {et~al.}(2016){Carroll}, {Line}, {Morales}, {Barry},
%DIFDELCMD <   {Beardsley}, {Hazelton}, {Jacobs}, {Pober}, {Sullivan}, {Webster},
%DIFDELCMD <   {Bernardi}, {Bowman}, {Briggs}, {Cappallo}, {Corey}, {de Oliveira-Costa},
%DIFDELCMD <   {Dillon}, {Emrich}, {Ewall-Wice}, {Feng}, {Gaensler}, {Goeke}, {Greenhill},
%DIFDELCMD <   {Hewitt}, {Hurley-Walker}, {Johnston-Hollitt}, {Kaplan}, {Kasper}, {Kim},
%DIFDELCMD <   {Kratzenberg}, {Lenc}, {Loeb}, {Lonsdale}, {Lynch}, {McKinley}, {McWhirter},
%DIFDELCMD <   {Mitchell}, {Morgan}, {Neben}, {Oberoi}, {Offringa}, {Ord}, {Paul}, {Pindor},
%DIFDELCMD <   {Prabu}, {Procopio}, {Riding}, {Rogers}, {Roshi}, {Shankar}, {Sethi},
%DIFDELCMD <   {Srivani}, {Subrahmanyan}, {Tegmark}, {Thyagarajan}, {Tingay}, {Trott},
%DIFDELCMD <   {Waterson}, {Wayth}, {Whitney}, {Williams}, {Williams}, {Wu}, \&
%DIFDELCMD <   {Wyithe}}]{PattiCatalog1}
%DIFDELCMD < {%%%
\DIFdel{Carroll}%DIFDELCMD < }%%%
\DIFdel{, P.~A., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2016, }%DIFDELCMD < \mnras%%%
\DIFdel{, 461, 4151
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Chang} {et~al.}(2010){Chang}, {Pen}, {Bandura}, \&
%DIFDELCMD <   {Peterson}}]{Chang2010}
%DIFDELCMD < {%%%
\DIFdel{Chang}%DIFDELCMD < }%%%
\DIFdel{, T.-C., }%DIFDELCMD < {%%%
\DIFdel{Pen}%DIFDELCMD < }%%%
\DIFdel{, U.-L., }%DIFDELCMD < {%%%
\DIFdel{Bandura}%DIFDELCMD < }%%%
\DIFdel{, K., }%DIFDELCMD < \& {%%%
\DIFdel{Peterson}%DIFDELCMD < }%%%
\DIFdel{, J.~B. 2010, }%DIFDELCMD < \nat%%%
\DIFdel{,
  466, 463
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Coe} {et~al.}(2015){Coe}, {Bradley}, \& {Zitrin}}]{Coe2015}
%DIFDELCMD < {%%%
\DIFdel{Coe}%DIFDELCMD < }%%%
\DIFdel{, D., }%DIFDELCMD < {%%%
\DIFdel{Bradley}%DIFDELCMD < }%%%
\DIFdel{, L., }%DIFDELCMD < \& {%%%
\DIFdel{Zitrin}%DIFDELCMD < }%%%
\DIFdel{, A. 2015, }%DIFDELCMD < \apj%%%
\DIFdel{, 800, 84
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Comaschi} {et~al.}(2016){Comaschi}, {Yue}, \&
%DIFDELCMD <   {Ferrara}}]{Comaschi16}
%DIFDELCMD < {%%%
\DIFdel{Comaschi}%DIFDELCMD < }%%%
\DIFdel{, P., }%DIFDELCMD < {%%%
\DIFdel{Yue}%DIFDELCMD < }%%%
\DIFdel{, B., }%DIFDELCMD < \& {%%%
\DIFdel{Ferrara}%DIFDELCMD < }%%%
\DIFdel{, A. 2016, }%DIFDELCMD < \mnras%%%
\DIFdel{, 463, 3193
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Cooray} {et~al.}(2012){Cooray}, {Smidt}, {de Bernardis}, {Gong},
%DIFDELCMD <   {Stern}, {Ashby}, {Eisenhardt}, {Frazer}, {Gonzalez}, {Kochanek},
%DIFDELCMD <   {Koz{\l}owski}, \& {Wright}}]{cooray12}
%DIFDELCMD < {%%%
\DIFdel{Cooray}%DIFDELCMD < }%%%
\DIFdel{, A., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
...
%DIFDELCMD < \bibitem[{{Cooray} {et~al.}(2016){Cooray}, {Bock}, {Burgarella}, {Chary},
%DIFDELCMD <   {Chang}, {Dor{\'e}}, {Fazio}, {Ferrara}, {Gong}, {Santos}, {Silva}, \&
%DIFDELCMD <   {Zemcov}}]{cooray16}
%DIFDELCMD < %%%
\DIFdel{---. 2016, ArXiv e-prints
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Cutri} {et~al.}(2013){Cutri}, {Wright}, {Conrow}, {Fowler},
%DIFDELCMD <   {Eisenhardt}, {Grillmair}, {Kirkpatrick}, {Masci}, {McCallon}, {Wheelock},
%DIFDELCMD <   {Fajardo-Acosta}, {Yan}, {Benford}, {Harbut}, {Jarrett}, {Lake}, {Leisawitz},
%DIFDELCMD <   {Ressler}, {Stanford}, {Tsai}, {Liu}, {Helou}, {Mainzer}, {Gettings},
%DIFDELCMD <   {Gonzalez}, {Hoffman}, {Marsh}, {Padgett}, {Skrutskie}, {Beck}, {Papin}, \&
%DIFDELCMD <   {Wittman}}]{allwise}
%DIFDELCMD < {%%%
\DIFdel{Cutri}%DIFDELCMD < }%%%
\DIFdel{, R.~M., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2013, }%DIFDELCMD < {%%%
\DIFdel{Explanatory Supplement to the AllWISE Data
  Release Products}%DIFDELCMD < }%%%
\DIFdel{, Tech. rep.
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Dark Energy Survey Collaboration} {et~al.}(2016){Dark Energy Survey
%DIFDELCMD <   Collaboration}, {Abbott}, {Abdalla}, {Aleksi{\'c}}, {Allam}, {Amara},
%DIFDELCMD <   {Bacon}, {Balbinot}, {Banerji}, {Bechtol}, {Benoit-L{\'e}vy}, {Bernstein},
%DIFDELCMD <   {Bertin}, {Blazek}, {Bonnett}, {Bridle}, {Brooks}, {Brunner}, {Buckley-Geer},
%DIFDELCMD <   {Burke}, {Caminha}, {Capozzi}, {Carlsen}, {Carnero-Rosell}, {Carollo},
%DIFDELCMD <   {Carrasco-Kind}, {Carretero}, {Castander}, {Clerkin}, {Collett}, {Conselice},
%DIFDELCMD <   {Crocce}, {Cunha}, {D'Andrea}, {da Costa}, {Davis}, {Desai}, {Diehl},
%DIFDELCMD <   {Dietrich}, {Dodelson}, {Doel}, {Drlica-Wagner}, {Estrada}, {Etherington},
%DIFDELCMD <   {Evrard}, {Fabbri}, {Finley}, {Flaugher}, {Foley}, {Fosalba}, {Frieman},
%DIFDELCMD <   {Garc{\'{\i}}a-Bellido}, {Gaztanaga}, {Gerdes}, {Giannantonio}, {Goldstein},
%DIFDELCMD <   {Gruen}, {Gruendl}, {Guarnieri}, {Gutierrez}, {Hartley}, {Honscheid}, {Jain},
%DIFDELCMD <   {James}, {Jeltema}, {Jouvel}, {Kessler}, {King}, {Kirk}, {Kron}, {Kuehn},
%DIFDELCMD <   {Kuropatkin}, {Lahav}, {Li}, {Lima}, {Lin}, {Maia}, {Makler}, {Manera},
%DIFDELCMD <   {Maraston}, {Marshall}, {Martini}, {McMahon}, {Melchior}, {Merson}, {Miller},
%DIFDELCMD <   {Miquel}, {Mohr}, {Morice-Atkinson}, {Naidoo}, {Neilsen}, {Nichol}, {Nord},
%DIFDELCMD <   {Ogando}, {Ostrovski}, {Palmese}, {Papadopoulos}, {Peiris}, {Peoples},
%DIFDELCMD <   {Percival}, {Plazas}, {Reed}, {Refregier}, {Romer}, {Roodman}, {Ross},
%DIFDELCMD <   {Rozo}, {Rykoff}, {Sadeh}, {Sako}, {S{\'a}nchez}, {Sanchez}, {Santiago},
%DIFDELCMD <   {Scarpine}, {Schubnell}, {Sevilla-Noarbe}, {Sheldon}, {Smith}, {Smith},
%DIFDELCMD <   {Soares-Santos}, {Sobreira}, {Soumagnac}, {Suchyta}, {Sullivan}, {Swanson},
%DIFDELCMD <   {Tarle}, {Thaler}, {Thomas}, {Thomas}, {Tucker}, {Vieira}, {Vikram},
%DIFDELCMD <   {Walker}, {Wechsler}, {Weller}, {Wester}, {Whiteway}, {Wilcox}, {Yanny},
%DIFDELCMD <   {Zhang}, \& {Zuntz}}]{des16}
%DIFDELCMD < {%%%
\DIFdel{Dark Energy Survey Collaboration}%DIFDELCMD < } {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2016, }%DIFDELCMD < \mnras%%%
\DIFdel{, 460, 1270
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{de Jong} {et~al.}(1985){de Jong}, {Klein}, {Wielebinski}, \&
%DIFDELCMD <   {Wunderlich}}]{dejong85}
%DIFDELCMD < {%%%
\DIFdel{de Jong}%DIFDELCMD < }%%%
\DIFdel{, T., }%DIFDELCMD < {%%%
\DIFdel{Klein}%DIFDELCMD < }%%%
\DIFdel{, U., }%DIFDELCMD < {%%%
\DIFdel{Wielebinski}%DIFDELCMD < }%%%
\DIFdel{, R., }%DIFDELCMD < \& {%%%
\DIFdel{Wunderlich}%DIFDELCMD < }%%%
\DIFdel{, E. 1985, }%DIFDELCMD < \aap%%%
\DIFdel{,
  147, L6
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{DeBoer} {et~al.}(2017){DeBoer}, {Parsons}, {Aguirre}, {Alexander},
%DIFDELCMD <   {Ali}, {Beardsley}, {Bernardi}, {Bowman}, {Bradley}, {Carilli}, {Cheng}, {de
%DIFDELCMD <   Lera Acedo}, {Dillon}, {Ewall-Wice}, {Fadana}, {Fagnoni}, {Fritz},
%DIFDELCMD <   {Furlanetto}, {Glendenning}, {Greig}, {Grobbelaar}, {Hazelton}, {Hewitt},
%DIFDELCMD <   {Hickish}, {Jacobs}, {Julius}, {Kariseb}, {Kohn}, {Lekalake}, {Liu}, {Loots},
%DIFDELCMD <   {MacMahon}, {Malan}, {Malgas}, {Maree}, {Mathison}, {Matsetela}, {Mesinger},
%DIFDELCMD <   {Morales}, {Neben}, {Patra}, {Pieterse}, {Pober}, {Razavi-Ghods},
%DIFDELCMD <   {Ringuette}, {Robnett}, {Rosie}, {Sell}, {Smith}, {Syce}, {Tegmark},
%DIFDELCMD <   {Thyagarajan}, {Williams}, \& {Zheng}}]{deboer16}
%DIFDELCMD < {%%%
\DIFdel{DeBoer}%DIFDELCMD < }%%%
\DIFdel{, D.~R., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2017, Publications of the Astronomical Society of the
  Pacific, 129, 045001
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{Dewdney \& Lazio(2008)}]{ska1}
%DIFDELCMD < %%%
\DIFdel{Dewdney, P., }%DIFDELCMD < \& %%%
\DIFdel{Lazio, T. 2008, Radio Science Bulletin, 5
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{Dewdney {et~al.}(2009)Dewdney, Hall, Schilizzi, \& Lazio}]{ska2}
%DIFDELCMD < %%%
\DIFdel{Dewdney, P.~E., Hall, P.~J., Schilizzi, R.~T., }%DIFDELCMD < \& %%%
\DIFdel{Lazio, T. J.~L. 2009,
  Proceedings of the IEEE, 97, 1482
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Di Matteo} {et~al.}(2002){Di Matteo}, {Perna}, {Abel}, \&
%DIFDELCMD <   {Rees}}]{dimatteo02}
%DIFDELCMD < {%%%
\DIFdel{Di Matteo}%DIFDELCMD < }%%%
\DIFdel{, T., }%DIFDELCMD < {%%%
\DIFdel{Perna}%DIFDELCMD < }%%%
\DIFdel{, R., }%DIFDELCMD < {%%%
\DIFdel{Abel}%DIFDELCMD < }%%%
\DIFdel{, T., }%DIFDELCMD < \& {%%%
\DIFdel{Rees}%DIFDELCMD < }%%%
\DIFdel{, M.~J. 2002, }%DIFDELCMD < \apj%%%
\DIFdel{, 564, 576
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Dillon} {et~al.}(2013){Dillon}, {Liu}, \& {Tegmark}}]{DillonFast}
%DIFDELCMD < {%%%
\DIFdel{Dillon}%DIFDELCMD < }%%%
\DIFdel{, J.~S., }%DIFDELCMD < {%%%
\DIFdel{Liu}%DIFDELCMD < }%%%
\DIFdel{, A., }%DIFDELCMD < \& {%%%
\DIFdel{Tegmark}%DIFDELCMD < }%%%
\DIFdel{, M. 2013, }%DIFDELCMD < \prd%%%
\DIFdel{, 87, 043005
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Dillon} {et~al.}(2014){Dillon}, {Liu}, {Williams}, {Hewitt},
%DIFDELCMD <   {Tegmark}, {Morgan}, {Levine}, {Morales}, {Tingay}, {Bernardi}, {Bowman},
%DIFDELCMD <   {Briggs}, {Cappallo}, {Emrich}, {Mitchell}, {Oberoi}, {Prabu}, {Wayth}, \&
%DIFDELCMD <   {Webster}}]{X13}
%DIFDELCMD < {%%%
\DIFdel{Dillon}%DIFDELCMD < }%%%
\DIFdel{, J.~S., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
...
%DIFDELCMD < \bibitem[{{Dillon} {et~al.}(2015){Dillon}, {Neben}, {Hewitt}, {Tegmark},
%DIFDELCMD <   {Barry}, {Beardsley}, {Bowman}, {Briggs}, {Carroll}, {de Oliveira-Costa},
%DIFDELCMD <   {Ewall-Wice}, {Feng}, {Greenhill}, {Hazelton}, {Hernquist}, {Hurley-Walker},
%DIFDELCMD <   {Jacobs}, {Kim}, {Kittiwisit}, {Lenc}, {Line}, {Loeb}, {McKinley},
%DIFDELCMD <   {Mitchell}, {Morales}, {Offringa}, {Paul}, {Pindor}, {Pober}, {Procopio},
%DIFDELCMD <   {Riding}, {Sethi}, {Shankar}, {Subrahmanyan}, {Sullivan}, {Thyagarajan},
%DIFDELCMD <   {Tingay}, {Trott}, {Wayth}, {Webster}, {Wyithe}, {Bernardi}, {Cappallo},
%DIFDELCMD <   {Deshpande}, {Johnston-Hollitt}, {Kaplan}, {Lonsdale}, {McWhirter}, {Morgan},
%DIFDELCMD <   {Oberoi}, {Ord}, {Prabu}, {Srivani}, {Williams}, \& {Williams}}]{dillonneben}
%DIFDELCMD < %%%
\DIFdel{---. 2015, }%DIFDELCMD < \prd%%%
\DIFdel{, 91, 123011
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Dodelson} {et~al.}(2002){Dodelson}, {Narayanan}, {Tegmark},
%DIFDELCMD <   {Scranton}, {Budav{\'a}ri}, {Connolly}, {Csabai}, {Eisenstein}, {Frieman},
%DIFDELCMD <   {Gunn}, {Hui}, {Jain}, {Johnston}, {Kent}, {Loveday}, {Nichol}, {O'Connell},
%DIFDELCMD <   {Scoccimarro}, {Sheth}, {Stebbins}, {Strauss}, {Szalay}, {Szapudi},
%DIFDELCMD <   {Vogeley}, {Zehavi}, {Annis}, {Bahcall}, {Brinkman}, {Doi}, {Fukugita},
%DIFDELCMD <   {Hennessy}, {Ivezi{\'c}}, {Knapp}, {Kunszt}, {Lamb}, {Lee}, {Lupton}, {Munn},
%DIFDELCMD <   {Peoples}, {Pier}, {Rockosi}, {Schlegel}, {Stoughton}, {Tucker}, {Yanny}, \&
%DIFDELCMD <   {York}}]{dodelson02}
%DIFDELCMD < {%%%
\DIFdel{Dodelson}%DIFDELCMD < }%%%
\DIFdel{, S., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2002, ApJ, 572, 140
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Dor{\'e}} {et~al.}(2014){Dor{\'e}}, {Bock}, {Ashby}, {Capak},
%DIFDELCMD <   {Cooray}, {de Putter}, {Eifler}, {Flagey}, {Gong}, {Habib}, {Heitmann},
%DIFDELCMD <   {Hirata}, {Jeong}, {Katti}, {Korngut}, {Krause}, {Lee}, {Masters},
%DIFDELCMD <   {Mauskopf}, {Melnick}, {Mennesson}, {Nguyen}, {{\"O}berg}, {Pullen},
%DIFDELCMD <   {Raccanelli}, {Smith}, {Song}, {Tolls}, {Unwin}, {Venumadhav}, {Viero},
%DIFDELCMD <   {Werner}, \& {Zemcov}}]{ScienceWithSpherex}
%DIFDELCMD < {%%%
\DIFdel{Dor}%DIFDELCMD < {\'e}}%%%
\DIFdel{, O., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2014, ArXiv e-prints
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Dor{\'e}} {et~al.}(2016){Dor{\'e}}, {Werner}, {Ashby}, {Banerjee},
%DIFDELCMD <   {Battaglia}, {Bauer}, {Benjamin}, {Bleem}, {Bock}, {Boogert}, {Bull},
%DIFDELCMD <   {Capak}, {Chang}, {Chiar}, {Cohen}, {Cooray}, {Crill}, {Cushing}, {de
%DIFDELCMD <   Putter}, {Driver}, {Eifler}, {Feng}, {Ferraro}, {Finkbeiner}, {Gaudi},
%DIFDELCMD <   {Greene}, {Hillenbrand}, {H{\"o}flich}, {Hsiao}, {Huffenberger}, {Jansen},
%DIFDELCMD <   {Jeong}, {Joshi}, {Kim}, {Kim}, {Kirkpatrick}, {Korngut}, {Krause}, {Kriek},
%DIFDELCMD <   {Leistedt}, {Li}, {Lisse}, {Mauskopf}, {Mechtley}, {Melnick}, {Mohr},
%DIFDELCMD <   {Murphy}, {Neben}, {Neufeld}, {Nguyen}, {Pierpaoli}, {Pyo}, {Rhodes},
%DIFDELCMD <   {Sandstrom}, {Schaan}, {Schlaufman}, {Silverman}, {Su}, {Stassun}, {Stevens},
%DIFDELCMD <   {Strauss}, {Tielens}, {Tsai}, {Tolls}, {Unwin}, {Viero}, {Windhorst}, \&
%DIFDELCMD <   {Zemcov}}]{SpherexWhitePaper}
%DIFDELCMD < %%%
\DIFdel{---. 2016, ArXiv e-prints
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Dunlop} {et~al.}(2013){Dunlop}, {Rogers}, {McLure}, {Ellis},
%DIFDELCMD <   {Robertson}, {Koekemoer}, {Dayal}, {Curtis-Lake}, {Wild}, {Charlot},
%DIFDELCMD <   {Bowler}, {Schenker}, {Ouchi}, {Ono}, {Cirasuolo}, {Furlanetto}, {Stark},
%DIFDELCMD <   {Targett}, \& {Schneider}}]{Dunlop2013}
%DIFDELCMD < {%%%
\DIFdel{Dunlop}%DIFDELCMD < }%%%
\DIFdel{, J.~S., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2013, }%DIFDELCMD < \mnras%%%
\DIFdel{, 432, 3520
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Eisenstein} {et~al.}(2011){Eisenstein}, {Weinberg}, {Agol},
%DIFDELCMD <   {Aihara}, {Allende Prieto}, {Anderson}, {Arns}, {Aubourg}, {Bailey},
%DIFDELCMD <   {Balbinot}, \& et~al.}]{sdssiii}
%DIFDELCMD < {%%%
\DIFdel{Eisenstein}%DIFDELCMD < }%%%
\DIFdel{, D.~J., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2011, }%DIFDELCMD < \aj%%%
\DIFdel{, 142, 72
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Ellis} {et~al.}(2013){Ellis}, {McLure}, {Dunlop}, {Robertson},
%DIFDELCMD <   {Ono}, {Schenker}, {Koekemoer}, {Bowler}, {Ouchi}, {Rogers}, {Curtis-Lake},
%DIFDELCMD <   {Schneider}, {Charlot}, {Stark}, {Furlanetto}, \& {Cirasuolo}}]{Ellis2013}
%DIFDELCMD < {%%%
\DIFdel{Ellis}%DIFDELCMD < }%%%
\DIFdel{, R.~S., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2013, }%DIFDELCMD < \apjl%%%
\DIFdel{, 763, L7
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Ewall-Wice} {et~al.}(2016){Ewall-Wice}, {Bradley}, {Deboer},
%DIFDELCMD <   {Hewitt}, {Parsons}, {Aguirre}, {Ali}, {Bowman}, {Cheng}, {Neben}, {Patra},
%DIFDELCMD <   {Thyagarajan}, {Venter}, {de Lera Acedo}, {Dillon}, {Dickenson}, {Doolittle},
%DIFDELCMD <   {Egan}, {Hedrick}, {Klima}, {Kohn}, {Schaffner}, {Shelton}, {Saliwanchik},
%DIFDELCMD <   {Taylor}, {Taylor}, {Tegmark}, \& {Wirt}}]{ewallwice16}
%DIFDELCMD < {%%%
\DIFdel{Ewall-Wice}%DIFDELCMD < }%%%
\DIFdel{, A., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2016, }%DIFDELCMD < \apj%%%
\DIFdel{, 831, 196
...
%DIFDELCMD < \bibitem[{{Feng} {et~al.}(2017){Feng}, {Cooray}, \& {Keating}}]{feng17}
%DIFDELCMD < {%%%
\DIFdel{Feng}%DIFDELCMD < }%%%
\DIFdel{, C., }%DIFDELCMD < {%%%
\DIFdel{Cooray}%DIFDELCMD < }%%%
\DIFdel{, A., }%DIFDELCMD < \& {%%%
\DIFdel{Keating}%DIFDELCMD < }%%%
\DIFdel{, B. 2017, ArXiv e-prints
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Fernandez} {et~al.}(2014){Fernandez}, {Zaroubi}, {Iliev}, {Mellema},
%DIFDELCMD <   \& {Jeli{\'c}}}]{StarsAndReionization}
%DIFDELCMD < {%%%
\DIFdel{Fernandez}%DIFDELCMD < }%%%
\DIFdel{, E.~R., }%DIFDELCMD < {%%%
\DIFdel{Zaroubi}%DIFDELCMD < }%%%
\DIFdel{, S., }%DIFDELCMD < {%%%
\DIFdel{Iliev}%DIFDELCMD < }%%%
\DIFdel{, I.~T., }%DIFDELCMD < {%%%
\DIFdel{Mellema}%DIFDELCMD < }%%%
\DIFdel{, G., }%DIFDELCMD < \&
%DIFDELCMD <   {%%%
\DIFdel{Jeli}%DIFDELCMD < {\'c}}%%%
\DIFdel{, V. 2014, }%DIFDELCMD < \mnras%%%
\DIFdel{, 440, 298
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Finkelstein}(2016)}]{Finkelstein2015}
%DIFDELCMD < {%%%
\DIFdel{Finkelstein}%DIFDELCMD < }%%%
\DIFdel{, S.~L. 2016, PASA, 33, e037
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Fixsen} {et~al.}(2000){Fixsen}, {Moseley}, \& {Arendt}}]{fixen00}
%DIFDELCMD < {%%%
\DIFdel{Fixsen}%DIFDELCMD < }%%%
\DIFdel{, D.~J., }%DIFDELCMD < {%%%
\DIFdel{Moseley}%DIFDELCMD < }%%%
\DIFdel{, S.~H., }%DIFDELCMD < \& {%%%
\DIFdel{Arendt}%DIFDELCMD < }%%%
\DIFdel{, R.~G. 2000, }%DIFDELCMD < \apjs%%%
\DIFdel{, 128, 651
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Fu} {et~al.}(2010){Fu}, {Yan}, {Scoville}, {Capak}, {Aussel}, {Le
%DIFDELCMD <   Floc'h}, {Ilbert}, {Salvato}, {Kartaltepe}, {Frayer}, {Sanders}, {Sheth}, \&
%DIFDELCMD <   {Taniguchi}}]{fu10}
%DIFDELCMD < {%%%
\DIFdel{Fu}%DIFDELCMD < }%%%
\DIFdel{, H., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
...
%DIFDELCMD < \bibitem[{Furlanetto {et~al.}(2006)Furlanetto, Oh, \&
%DIFDELCMD <   Briggs}]{FurlanettoReview}
%DIFDELCMD < %%%
\DIFdel{Furlanetto, S., Oh, S., }%DIFDELCMD < \& %%%
\DIFdel{Briggs, F. 2006, Physics Reports, 433, 181
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{Furlanetto \& Lidz(2007)}]{furlanettolidz07}
%DIFDELCMD < %%%
\DIFdel{Furlanetto, S.~R., }%DIFDELCMD < \& %%%
\DIFdel{Lidz, A. 2007, ApJ, 660, 1030
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{Gardner {et~al.}(2006)Gardner, Mather, Clampin, Doyon, Greenhouse,
%DIFDELCMD <   Hammel, Hutchings, Jakobsen, Lilly, Long, Lunine, McCaughrean, Mountain,
%DIFDELCMD <   Nella, Rieke, Rieke, Rix, Smith, Sonneborn, Stiavelli, Stockman, Windhorst,
%DIFDELCMD <   \& Wright}]{Gardner2006}
%DIFDELCMD < %%%
\DIFdel{Gardner, J.~P., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2006, Space Science Reviews, 123, 485
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Gong} {et~al.}(2017){Gong}, {Cooray}, {Silva}, {Zemcov}, {Feng},
%DIFDELCMD <   {Santos}, {Dore}, \& {Chen}}]{gong17}
%DIFDELCMD < {%%%
\DIFdel{Gong}%DIFDELCMD < }%%%
\DIFdel{, Y., }%DIFDELCMD < {%%%
\DIFdel{Cooray}%DIFDELCMD < }%%%
\DIFdel{, A., }%DIFDELCMD < {%%%
\DIFdel{Silva}%DIFDELCMD < }%%%
\DIFdel{, M.~B., }%DIFDELCMD < {%%%
\DIFdel{Zemcov}%DIFDELCMD < }%%%
\DIFdel{, M., }%DIFDELCMD < {%%%
\DIFdel{Feng}%DIFDELCMD < }%%%
\DIFdel{, C., }%DIFDELCMD < {%%%
\DIFdel{Santos}%DIFDELCMD < }%%%
\DIFdel{,
  M.~G., }%DIFDELCMD < {%%%
\DIFdel{Dore}%DIFDELCMD < }%%%
\DIFdel{, O., }%DIFDELCMD < \& {%%%
\DIFdel{Chen}%DIFDELCMD < }%%%
\DIFdel{, X. 2017, }%DIFDELCMD < \apj%%%
\DIFdel{, 835, 273
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Gong} {et~al.}(2014){Gong}, {Silva}, {Cooray}, \&
%DIFDELCMD <   {Santos}}]{Gong2014}
%DIFDELCMD < {%%%
\DIFdel{Gong}%DIFDELCMD < }%%%
\DIFdel{, Y., }%DIFDELCMD < {%%%
\DIFdel{Silva}%DIFDELCMD < }%%%
...
\DIFdel{, A., }%DIFDELCMD < \& {%%%
\DIFdel{Santos}%DIFDELCMD < }%%%
\DIFdel{, M.~G. 2014, }%DIFDELCMD < \apj%%%
\DIFdel{, 785, 72
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Grogin} {et~al.}(2011){Grogin}, {Kocevski}, {Faber}, {Ferguson},
%DIFDELCMD <   {Koekemoer}, {Riess}, {Acquaviva}, {Alexander}, {Almaini}, {Ashby}, {Barden},
%DIFDELCMD <   {Bell}, {Bournaud}, {Brown}, {Caputi}, {Casertano}, {Cassata}, {Castellano},
%DIFDELCMD <   {Challis}, {Chary}, {Cheung}, {Cirasuolo}, {Conselice}, {Roshan Cooray},
%DIFDELCMD <   {Croton}, {Daddi}, {Dahlen}, {Dav{\'e}}, {de Mello}, {Dekel}, {Dickinson},
%DIFDELCMD <   {Dolch}, {Donley}, {Dunlop}, {Dutton}, {Elbaz}, {Fazio}, {Filippenko},
%DIFDELCMD <   {Finkelstein}, {Fontana}, {Gardner}, {Garnavich}, {Gawiser}, {Giavalisco},
%DIFDELCMD <   {Grazian}, {Guo}, {Hathi}, {H{\"a}ussler}, {Hopkins}, {Huang}, {Huang},
%DIFDELCMD <   {Jha}, {Kartaltepe}, {Kirshner}, {Koo}, {Lai}, {Lee}, {Li}, {Lotz}, {Lucas},
%DIFDELCMD <   {Madau}, {McCarthy}, {McGrath}, {McIntosh}, {McLure}, {Mobasher},
%DIFDELCMD <   {Moustakas}, {Mozena}, {Nandra}, {Newman}, {Niemi}, {Noeske}, {Papovich},
%DIFDELCMD <   {Pentericci}, {Pope}, {Primack}, {Rajan}, {Ravindranath}, {Reddy}, {Renzini},
%DIFDELCMD <   {Rix}, {Robaina}, {Rodney}, {Rosario}, {Rosati}, {Salimbeni}, {Scarlata},
%DIFDELCMD <   {Siana}, {Simard}, {Smidt}, {Somerville}, {Spinrad}, {Straughn}, {Strolger},
%DIFDELCMD <   {Telford}, {Teplitz}, {Trump}, {van der Wel}, {Villforth}, {Wechsler},
%DIFDELCMD <   {Weiner}, {Wiklind}, {Wild}, {Wilson}, {Wuyts}, {Yan}, \& {Yun}}]{Grogin2011}
%DIFDELCMD < {%%%
\DIFdel{Grogin}%DIFDELCMD < }%%%
\DIFdel{, N.~A., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2011, }%DIFDELCMD < \apjs%%%
\DIFdel{, 197, 35
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Hall}(2005)}]{ska}
%DIFDELCMD < {%%%
\DIFdel{Hall}%DIFDELCMD < }%%%
\DIFdel{, P.~J. 2005, }%DIFDELCMD < {%%%
\DIFdel{The Square Kilometre Array: An Engineering Perspective}%DIFDELCMD < }
%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Helgason} {et~al.}(2016){Helgason}, {Ricotti}, {Kashlinsky}, \&
%DIFDELCMD <   {Bromm}}]{kash4}
%DIFDELCMD < {%%%
\DIFdel{Helgason}%DIFDELCMD < }%%%
\DIFdel{, K., }%DIFDELCMD < {%%%
\DIFdel{Ricotti}%DIFDELCMD < }%%%
\DIFdel{, M., }%DIFDELCMD < {%%%
\DIFdel{Kashlinsky}%DIFDELCMD < }%%%
\DIFdel{, A., }%DIFDELCMD < \& {%%%
\DIFdel{Bromm}%DIFDELCMD < }%%%
\DIFdel{, V. 2016, }%DIFDELCMD < \mnras%%%
\DIFdel{,
  455, 282
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Helou} {et~al.}(1985){Helou}, {Soifer}, \&
%DIFDELCMD <   {Rowan-Robinson}}]{helou85}
%DIFDELCMD < {%%%
\DIFdel{Helou}%DIFDELCMD < }%%%
\DIFdel{, G., }%DIFDELCMD < {%%%
\DIFdel{Soifer}%DIFDELCMD < }%%%
\DIFdel{, B.~T., }%DIFDELCMD < \& {%%%
\DIFdel{Rowan-Robinson}%DIFDELCMD < }%%%
\DIFdel{, M. 1985, ApJL, 298, L7
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Henden} {et~al.}(2016){Henden}, {Templeton}, {Terrell}, {Smith},
%DIFDELCMD <   {Levine}, \& {Welch}}]{apass}
%DIFDELCMD < {%%%
\DIFdel{Henden}%DIFDELCMD < }%%%
\DIFdel{, A.~A., }%DIFDELCMD < {%%%
\DIFdel{Templeton}%DIFDELCMD < }%%%
\DIFdel{, M., }%DIFDELCMD < {%%%
\DIFdel{Terrell}%DIFDELCMD < }%%%
\DIFdel{, D., }%DIFDELCMD < {%%%
\DIFdel{Smith}%DIFDELCMD < }%%%
\DIFdel{, T.~C., }%DIFDELCMD < {%%%
\DIFdel{Levine}%DIFDELCMD < }%%%
\DIFdel{, S.,
  }%DIFDELCMD < \& {%%%
\DIFdel{Welch}%DIFDELCMD < }%%%
\DIFdel{, D. 2016, VizieR Online Data Catalog, 2336
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Heneka} {et~al.}(2016){Heneka}, {Cooray}, \& {Feng}}]{Heneka2016}
%DIFDELCMD < {%%%
\DIFdel{Heneka}%DIFDELCMD < }%%%
\DIFdel{, C., }%DIFDELCMD < {%%%
\DIFdel{Cooray}%DIFDELCMD < }%%%
\DIFdel{, A., }%DIFDELCMD < \& {%%%
\DIFdel{Feng}%DIFDELCMD < }%%%
...
%DIFDELCMD < \bibitem[{{High} {et~al.}(2010){High}, {Stubbs}, {Stalder}, {Gilmore}, \&
%DIFDELCMD <   {Tonry}}]{high10}
%DIFDELCMD < {%%%
\DIFdel{High}%DIFDELCMD < }%%%
\DIFdel{, F.~W., }%DIFDELCMD < {%%%
\DIFdel{Stubbs}%DIFDELCMD < }%%%
\DIFdel{, C.~W., }%DIFDELCMD < {%%%
\DIFdel{Stalder}%DIFDELCMD < }%%%
\DIFdel{, B., }%DIFDELCMD < {%%%
\DIFdel{Gilmore}%DIFDELCMD < }%%%
\DIFdel{, D.~K., }%DIFDELCMD < \& {%%%
\DIFdel{Tonry}%DIFDELCMD < }%%%
\DIFdel{,
  J.~L. 2010, }%DIFDELCMD < \pasp%%%
\DIFdel{, 122, 722
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Huang} {et~al.}(2016){Huang}, {Brada{\v c}}, {Lemaux}, {Ryan},
%DIFDELCMD <   {Hoag}, {Castellano}, {Amor{\'{\i}}n}, {Fontana}, {Brammer}, {Cain}, {Lubin},
%DIFDELCMD <   {Merlin}, {Schmidt}, {Schrabback}, {Treu}, {Gonzalez}, {von der Linden}, \&
%DIFDELCMD <   {Knight}}]{Huang2015}
%DIFDELCMD < {%%%
\DIFdel{Huang}%DIFDELCMD < }%%%
\DIFdel{, K.-H., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2016, }%DIFDELCMD < \apj%%%
\DIFdel{, 817, 11
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Illingworth} {et~al.}(2013){Illingworth}, {Magee}, {Oesch},
%DIFDELCMD <   {Bouwens}, {Labb{\'e}}, {Stiavelli}, {van Dokkum}, {Franx}, {Trenti},
%DIFDELCMD <   {Carollo}, \& {Gonzalez}}]{Illingworth2013}
%DIFDELCMD < {%%%
\DIFdel{Illingworth}%DIFDELCMD < }%%%
\DIFdel{, G.~D., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2013, }%DIFDELCMD < \apjs%%%
\DIFdel{, 209, 6
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Intema} {et~al.}(2017){Intema}, {Jagannathan}, {Mooley}, \&
%DIFDELCMD <   {Frail}}]{intema17}
%DIFDELCMD < {%%%
\DIFdel{Intema}%DIFDELCMD < }%%%
\DIFdel{, H.~T., }%DIFDELCMD < {%%%
\DIFdel{Jagannathan}%DIFDELCMD < }%%%
\DIFdel{, P., }%DIFDELCMD < {%%%
\DIFdel{Mooley}%DIFDELCMD < }%%%
\DIFdel{, K.~P., }%DIFDELCMD < \& {%%%
\DIFdel{Frail}%DIFDELCMD < }%%%
\DIFdel{, D.~A. 2017,
  }%DIFDELCMD < \aap%%%
\DIFdel{, 598, A78
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Jacobs} {et~al.}(2015){Jacobs}, {Pober}, {Parsons}, {Aguirre},
%DIFDELCMD <   {Ali}, {Bowman}, {Bradley}, {Carilli}, {DeBoer}, {Dexter}, {Gugliucci},
%DIFDELCMD <   {Klima}, {Liu}, {MacMahon}, {Manley}, {Moore}, {Stefan}, \&
%DIFDELCMD <   {Walbrugh}}]{DannyMultiRedshift}
%DIFDELCMD < {%%%
\DIFdel{Jacobs}%DIFDELCMD < }%%%
\DIFdel{, D.~C., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2015, }%DIFDELCMD < \apj%%%
\DIFdel{, 801, 51
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Kashlinsky} {et~al.}(2012){Kashlinsky}, {Arendt}, {Ashby}, {Fazio},
%DIFDELCMD <   {Mather}, \& {Moseley}}]{kash3}
%DIFDELCMD < {%%%
\DIFdel{Kashlinsky}%DIFDELCMD < }%%%
\DIFdel{, A., }%DIFDELCMD < {%%%
\DIFdel{Arendt}%DIFDELCMD < }%%%
\DIFdel{, R.~G., }%DIFDELCMD < {%%%
\DIFdel{Ashby}%DIFDELCMD < }%%%
\DIFdel{, M.~L.~N., }%DIFDELCMD < {%%%
\DIFdel{Fazio}%DIFDELCMD < }%%%
\DIFdel{, G.~G., }%DIFDELCMD < {%%%
\DIFdel{Mather}%DIFDELCMD < }%%%
\DIFdel{,
  J., }%DIFDELCMD < \& {%%%
\DIFdel{Moseley}%DIFDELCMD < }%%%
\DIFdel{, S.~H. 2012, }%DIFDELCMD < \apj%%%
\DIFdel{, 753, 63
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Kashlinsky} {et~al.}(2005){Kashlinsky}, {Arendt}, {Mather}, \&
%DIFDELCMD <   {Moseley}}]{kash1}
%DIFDELCMD < {%%%
\DIFdel{Kashlinsky}%DIFDELCMD < }%%%
\DIFdel{, A., }%DIFDELCMD < {%%%
\DIFdel{Arendt}%DIFDELCMD < }%%%
...
%DIFDELCMD < \bibitem[{{Kashlinsky} {et~al.}(2007){Kashlinsky}, {Arendt}, {Mather}, \&
%DIFDELCMD <   {Moseley}}]{kash2}
%DIFDELCMD < %%%
\DIFdel{---. 2007, }%DIFDELCMD < \apjl%%%
\DIFdel{, 657, L131
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Kurcz} {et~al.}(2016){Kurcz}, {Bilicki}, {Solarz}, {Krupa}, {Pollo},
%DIFDELCMD <   \& {Ma{\l}ek}}]{kurcz16}
%DIFDELCMD < {%%%
\DIFdel{Kurcz}%DIFDELCMD < }%%%
\DIFdel{, A., }%DIFDELCMD < {%%%
\DIFdel{Bilicki}%DIFDELCMD < }%%%
\DIFdel{, M., }%DIFDELCMD < {%%%
\DIFdel{Solarz}%DIFDELCMD < }%%%
\DIFdel{, A., }%DIFDELCMD < {%%%
\DIFdel{Krupa}%DIFDELCMD < }%%%
\DIFdel{, M., }%DIFDELCMD < {%%%
\DIFdel{Pollo}%DIFDELCMD < }%%%
\DIFdel{, A., }%DIFDELCMD < \&
%DIFDELCMD <   {%%%
\DIFdel{Ma}%DIFDELCMD < {%%%
\DIFdel{\l}%DIFDELCMD < }%%%
\DIFdel{ek}%DIFDELCMD < }%%%
\DIFdel{, K. 2016, }%DIFDELCMD < \aap%%%
\DIFdel{, 592, A25
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Lidz} {et~al.}(2009){Lidz}, {Zahn}, {Furlanetto}, {McQuinn},
%DIFDELCMD <   {Hernquist}, \& {Zaldarriaga}}]{lidz09}
%DIFDELCMD < {%%%
\DIFdel{Lidz}%DIFDELCMD < }%%%
\DIFdel{, A., }%DIFDELCMD < {%%%
\DIFdel{Zahn}%DIFDELCMD < }%%%
\DIFdel{, O., }%DIFDELCMD < {%%%
\DIFdel{Furlanetto}%DIFDELCMD < }%%%
\DIFdel{, S.~R., }%DIFDELCMD < {%%%
\DIFdel{McQuinn}%DIFDELCMD < }%%%
\DIFdel{, M., }%DIFDELCMD < {%%%
\DIFdel{Hernquist}%DIFDELCMD < }%%%
\DIFdel{, L., }%DIFDELCMD < \&
%DIFDELCMD <   {%%%
\DIFdel{Zaldarriaga}%DIFDELCMD < }%%%
\DIFdel{, M. 2009, }%DIFDELCMD < \apj%%%
\DIFdel{, 690, 252
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Liu} \& {Tegmark}(2011)}]{LT11}
%DIFDELCMD < {%%%
\DIFdel{Liu}%DIFDELCMD < }%%%
\DIFdel{, A., }%DIFDELCMD < \& {%%%
\DIFdel{Tegmark}%DIFDELCMD < }%%%
\DIFdel{, M. 2011, }%DIFDELCMD < \prd%%%
\DIFdel{, 83, 103006
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Livermore} {et~al.}(2017){Livermore}, {Finkelstein}, \&
%DIFDELCMD <   {Lotz}}]{Livermore2016}
%DIFDELCMD < {%%%
\DIFdel{Livermore}%DIFDELCMD < }%%%
\DIFdel{, R.~C., }%DIFDELCMD < {%%%
\DIFdel{Finkelstein}%DIFDELCMD < }%%%
\DIFdel{, S.~L., }%DIFDELCMD < \& {%%%
\DIFdel{Lotz}%DIFDELCMD < }%%%
\DIFdel{, J.~M. 2017, }%DIFDELCMD < \apj%%%
\DIFdel{, 835, 113
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Mao}(2014)}]{mao14}
%DIFDELCMD < {%%%
\DIFdel{Mao}%DIFDELCMD < }%%%
\DIFdel{, X.-C. 2014, }%DIFDELCMD < \apj%%%
\DIFdel{, 790, 148
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Masui} {et~al.}(2013){Masui}, {Switzer}, {Banavar}, {Bandura},
%DIFDELCMD <   {Blake}, {Calin}, {Chang}, {Chen}, {Li}, {Liao}, {Natarajan}, {Pen},
%DIFDELCMD <   {Peterson}, {Shaw}, \& {Voytek}}]{Masui2013}
%DIFDELCMD < {%%%
\DIFdel{Masui}%DIFDELCMD < }%%%
\DIFdel{, K.~W., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2013, }%DIFDELCMD < \apjl%%%
\DIFdel{, 763, L20
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Mauch} \& {Sadler}(2007)}]{mauch07}
%DIFDELCMD < {%%%
\DIFdel{Mauch}%DIFDELCMD < }%%%
\DIFdel{, T., }%DIFDELCMD < \& {%%%
\DIFdel{Sadler}%DIFDELCMD < }%%%
\DIFdel{, E.~M. 2007, }%DIFDELCMD < \mnras%%%
\DIFdel{, 375, 931
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{McLeod} {et~al.}(2016){McLeod}, {McLure}, \& {Dunlop}}]{McLeod2016}
%DIFDELCMD < {%%%
\DIFdel{McLeod}%DIFDELCMD < }%%%
\DIFdel{, D.~J., }%DIFDELCMD < {%%%
\DIFdel{McLure}%DIFDELCMD < }%%%
\DIFdel{, R.~J., }%DIFDELCMD < \& {%%%
\DIFdel{Dunlop}%DIFDELCMD < }%%%
\DIFdel{, J.~S. 2016, }%DIFDELCMD < \mnras%%%
\DIFdel{, 459, 3812
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{McLeod} {et~al.}(2015){McLeod}, {McLure}, {Dunlop}, {Robertson},
%DIFDELCMD <   {Ellis}, \& {Targett}}]{McLeod2015}
%DIFDELCMD < {%%%
\DIFdel{McLeod}%DIFDELCMD < }%%%
\DIFdel{, D.~J., }%DIFDELCMD < {%%%
\DIFdel{McLure}%DIFDELCMD < }%%%
...
\DIFdel{Dunlop}%DIFDELCMD < }%%%
\DIFdel{, J.~S., }%DIFDELCMD < {%%%
\DIFdel{Robertson}%DIFDELCMD < }%%%
\DIFdel{, B.~E., }%DIFDELCMD < {%%%
\DIFdel{Ellis}%DIFDELCMD < }%%%
\DIFdel{,
  R.~S., }%DIFDELCMD < \& {%%%
\DIFdel{Targett}%DIFDELCMD < }%%%
\DIFdel{, T.~A. 2015, }%DIFDELCMD < \mnras%%%
\DIFdel{, 450, 3032
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Mesinger}(2016)}]{Mesinger16}
%DIFDELCMD < {%%%
\DIFdel{Mesinger}%DIFDELCMD < }%%%
\DIFdel{, A., ed. 2016, Astrophysics and Space Science Library, Vol. 423,
  }%DIFDELCMD < {%%%
\DIFdel{Understanding the Epoch of Cosmic Reionization}%DIFDELCMD < }
%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Mitchell-Wynne} {et~al.}(2015){Mitchell-Wynne}, {Cooray}, {Gong},
%DIFDELCMD <   {Ashby}, {Dolch}, {Ferguson}, {Finkelstein}, {Grogin}, {Kocevski},
%DIFDELCMD <   {Koekemoer}, {Primack}, \& {Smidt}}]{mw15}
%DIFDELCMD < {%%%
\DIFdel{Mitchell-Wynne}%DIFDELCMD < }%%%
\DIFdel{, K., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2015, Nature Communications, 6, 7945
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Morales} \& {Wyithe}(2010)}]{miguelreview}
%DIFDELCMD < {%%%
\DIFdel{Morales}%DIFDELCMD < }%%%
\DIFdel{, M.~F., }%DIFDELCMD < \& {%%%
\DIFdel{Wyithe}%DIFDELCMD < }%%%
\DIFdel{, J.~S.~B. 2010, Annual Reviews of Astronomy and
  Astrophysics, 48, 127
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Neben} {et~al.}(2016){Neben}, {Bradley}, {Hewitt}, {DeBoer},
%DIFDELCMD <   {Parsons}, {Aguirre}, {Ali}, {Cheng}, {Ewall-Wice}, {Patra}, {Thyagarajan},
%DIFDELCMD <   {Bowman}, {Dickenson}, {Dillon}, {Doolittle}, {Egan}, {Hedrick}, {Jacobs},
%DIFDELCMD <   {Kohn}, {Klima}, {Moodley}, {Saliwanchik}, {Schaffner}, {Shelton}, {Taylor},
%DIFDELCMD <   {Taylor}, {Tegmark}, {Wirt}, \& {Zheng}}]{neben16b}
%DIFDELCMD < {%%%
\DIFdel{Neben}%DIFDELCMD < }%%%
\DIFdel{, A.~R., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2016, ApJ, 826, 199
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Nikutta} {et~al.}(2014){Nikutta}, {Hunt-Walker}, {Nenkova},
%DIFDELCMD <   {Ivezi{\'c}}, \& {Elitzur}}]{nikutta14}
%DIFDELCMD < {%%%
\DIFdel{Nikutta}%DIFDELCMD < }%%%
\DIFdel{, R., }%DIFDELCMD < {%%%
\DIFdel{Hunt-Walker}%DIFDELCMD < }%%%
\DIFdel{, N., }%DIFDELCMD < {%%%
\DIFdel{Nenkova}%DIFDELCMD < }%%%
\DIFdel{, M., }%DIFDELCMD < {%%%
\DIFdel{Ivezi}%DIFDELCMD < {\'c}}%%%
\DIFdel{, }%DIFDELCMD < {\v %%%
\DIFdel{Z}%DIFDELCMD < }%%%
\DIFdel{., }%DIFDELCMD < \&
%DIFDELCMD <   {%%%
\DIFdel{Elitzur}%DIFDELCMD < }%%%
\DIFdel{, M. 2014, }%DIFDELCMD < \mnras%%%
\DIFdel{, 442, 3361
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Oesch} {et~al.}(2013){Oesch}, {Bouwens}, {Illingworth}, {Labb{\'e}},
%DIFDELCMD <   {Franx}, {van Dokkum}, {Trenti}, {Stiavelli}, {Gonzalez}, \&
%DIFDELCMD <   {Magee}}]{Oesch2013}
%DIFDELCMD < {%%%
\DIFdel{Oesch}%DIFDELCMD < }%%%
\DIFdel{, P.~A., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2013, }%DIFDELCMD < \apj%%%
\DIFdel{, 773, 75
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Offringa} {et~al.}(2015){Offringa}, {Wayth}, {Hurley-Walker},
%DIFDELCMD <   {Kaplan}, {Barry}, {Beardsley}, {Bell}, {Bernardi}, {Bowman}, {Briggs},
%DIFDELCMD <   {Callingham}, {Cappallo}, {Carroll}, {Deshpande}, {Dillon}, {Dwarakanath},
%DIFDELCMD <   {Ewall-Wice}, {Feng}, {For}, {Gaensler}, {Greenhill}, {Hancock}, {Hazelton},
%DIFDELCMD <   {Hewitt}, {Hindson}, {Jacobs}, {Johnston-Hollitt}, {Kapi{\'n}ska}, {Kim},
%DIFDELCMD <   {Kittiwisit}, {Lenc}, {Line}, {Loeb}, {Lonsdale}, {McKinley}, {McWhirter},
%DIFDELCMD <   {Mitchell}, {Morales}, {Morgan}, {Morgan}, {Neben}, {Oberoi}, {Ord}, {Paul},
%DIFDELCMD <   {Pindor}, {Pober}, {Prabu}, {Procopio}, {Riding}, {Udaya Shankar}, {Sethi},
%DIFDELCMD <   {Srivani}, {Staveley-Smith}, {Subrahmanyan}, {Sullivan}, {Tegmark},
%DIFDELCMD <   {Thyagarajan}, {Tingay}, {Trott}, {Webster}, {Williams}, {Williams}, {Wu},
%DIFDELCMD <   {Wyithe}, \& {Zheng}}]{AndreMWARFI}
%DIFDELCMD < {%%%
\DIFdel{Offringa}%DIFDELCMD < }%%%
\DIFdel{, A.~R., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2015, PASP, 32, e008
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Park} {et~al.}(2014){Park}, {Kim}, {Wyithe}, \& {Lacey}}]{park14}
%DIFDELCMD < {%%%
\DIFdel{Park}%DIFDELCMD < }%%%
\DIFdel{, J., }%DIFDELCMD < {%%%
\DIFdel{Kim}%DIFDELCMD < }%%%
\DIFdel{, H.-S., }%DIFDELCMD < {%%%
\DIFdel{Wyithe}%DIFDELCMD < }%%%
\DIFdel{, J.~S.~B., }%DIFDELCMD < \& {%%%
\DIFdel{Lacey}%DIFDELCMD < }%%%
\DIFdel{, C.~G. 2014, }%DIFDELCMD < \mnras%%%
\DIFdel{,
  438, 2474
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Parsons} {et~al.}(2014){Parsons}, {Liu}, {Aguirre}, {Ali},
%DIFDELCMD <   {Bradley}, {Carilli}, {DeBoer}, {Dexter}, {Gugliucci}, {Jacobs}, {Klima},
%DIFDELCMD <   {MacMahon}, {Manley}, {Moore}, {Pober}, {Stefan}, \& {Walbrugh}}]{parsons14}
%DIFDELCMD < {%%%
\DIFdel{Parsons}%DIFDELCMD < }%%%
\DIFdel{, A.~R., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2014, }%DIFDELCMD < {%%%
\DIFdel{ApJ}%DIFDELCMD < }%%%
\DIFdel{, 788, 106
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Patra} {et~al.}(2017){Patra}, {Parsons}, {DeBoer}, {Thyagarajan},
%DIFDELCMD <   {Ewall-Wice}, {Hsyu}, {Kuk Leung}, {Day}, {Aguirre}, {Alexander}, {Ali},
%DIFDELCMD <   {Beardsley}, {Bowman}, {Bradley}, {Carilli}, {Cheng}, {de Lera Acedo},
%DIFDELCMD <   {Dillon}, {Fadana}, {Fagnoni}, {Fritz}, {Furlanetto}, {Glendenning}, {Greig},
%DIFDELCMD <   {Grobbelaar}, {Hazelton}, {Hewitt}, {Jacobs}, {Julius}, {Kariseb}, {Kohn},
%DIFDELCMD <   {Lebedeva}, {Lekalake}, {Liu}, {Loots}, {MacMahon}, {Malan}, {Malgas},
%DIFDELCMD <   {Maree}, {Martinot}, {Mathison}, {Matsetela}, {Mesinger}, {Morales}, {Neben},
%DIFDELCMD <   {Pieterse}, {Pober}, {Razavi-Ghods}, {Ringuette}, {Robnett}, {Rosie}, {Sell},
%DIFDELCMD <   {Smith}, {Syce}, {Tegmark}, {Williams}, \& {Zheng}}]{patra16}
%DIFDELCMD < {%%%
\DIFdel{Patra}%DIFDELCMD < }%%%
\DIFdel{, N., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2017, ArXiv e-prints
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Planck Collaboration} {et~al.}(2016){Planck Collaboration}, {Ade},
%DIFDELCMD <   {Aghanim}, {Arnaud}, {Ashdown}, {Aumont}, {Baccigalupi}, {Banday},
%DIFDELCMD <   {Barreiro}, {Bartlett}, \& et~al.}]{planck16}
%DIFDELCMD < {%%%
\DIFdel{Planck Collaboration}%DIFDELCMD < } {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2016, }%DIFDELCMD < \aap%%%
\DIFdel{, 594, A13
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Pober} {et~al.}(2014){Pober}, {Liu}, {Dillon}, {Aguirre}, {Bowman},
%DIFDELCMD <   {Bradley}, {Carilli}, {DeBoer}, {Hewitt}, {Jacobs}, {McQuinn}, {Morales},
%DIFDELCMD <   {Parsons}, {Tegmark}, \& {Werthimer}}]{PoberNextGen}
%DIFDELCMD < {%%%
\DIFdel{Pober}%DIFDELCMD < }%%%
\DIFdel{, J.~C., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2014, }%DIFDELCMD < \apj%%%
\DIFdel{, 782, 66
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Pober} {et~al.}(2015){Pober}, {Ali}, {Parsons}, {McQuinn},
%DIFDELCMD <   {Aguirre}, {Bernardi}, {Bradley}, {Carilli}, {Cheng}, {DeBoer}, {Dexter},
%DIFDELCMD <   {Furlanetto}, {Grobbelaar}, {Horrell}, {Jacobs}, {Klima}, {Kohn}, {Liu},
%DIFDELCMD <   {MacMahon}, {Maree}, {Mesinger}, {Moore}, {Razavi-Ghods}, {Stefan},
%DIFDELCMD <   {Walbrugh}, {Walker}, \& {Zheng}}]{PoberPAPER64Heating}
%DIFDELCMD < %%%
\DIFdel{---. 2015, ApJ, 809, 62
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Prandoni} \& {Seymour}(2015)}]{prandoni15}
%DIFDELCMD < {%%%
\DIFdel{Prandoni}%DIFDELCMD < }%%%
\DIFdel{, I., }%DIFDELCMD < \& {%%%
\DIFdel{Seymour}%DIFDELCMD < }%%%
\DIFdel{, N. 2015, Advancing Astrophysics with the Square
  Kilometre Array (AASKA14), 67
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Prescott} {et~al.}(2016){Prescott}, {Mauch}, {Jarvis}, {McAlpine},
%DIFDELCMD <   {Smith}, {Fine}, {Johnston}, {Hardcastle}, {Baldry}, {Brough}, {Brown},
%DIFDELCMD <   {Bremer}, {Driver}, {Hopkins}, {Kelvin}, {Loveday}, {Norberg}, {Obreschkow},
%DIFDELCMD <   \& {Sadler}}]{prescott16}
%DIFDELCMD < {%%%
\DIFdel{Prescott}%DIFDELCMD < }%%%
\DIFdel{, M., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2016, }%DIFDELCMD < \mnras%%%
\DIFdel{, 457, 730
...
%DIFDELCMD < \bibitem[{{Pritchard} \& {Loeb}(2012)}]{PritchardLoebReview}
%DIFDELCMD < {%%%
\DIFdel{Pritchard}%DIFDELCMD < }%%%
\DIFdel{, J.~R., }%DIFDELCMD < \& {%%%
\DIFdel{Loeb}%DIFDELCMD < }%%%
\DIFdel{, A. 2012, Reports on Progress in Physics, 75,
  086901
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Pullen} {et~al.}(2014){Pullen}, {Dor{\'e}}, \& {Bock}}]{pullen14}
%DIFDELCMD < {%%%
\DIFdel{Pullen}%DIFDELCMD < }%%%
\DIFdel{, A.~R., }%DIFDELCMD < {%%%
\DIFdel{Dor}%DIFDELCMD < {\'e}}%%%
\DIFdel{, O., }%DIFDELCMD < \& {%%%
\DIFdel{Bock}%DIFDELCMD < }%%%
\DIFdel{, J. 2014, }%DIFDELCMD < \apj%%%
\DIFdel{, 786, 111
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Repp} {et~al.}(2016){Repp}, {Ebeling}, \& {Richard}}]{Ebeling2016}
%DIFDELCMD < {%%%
\DIFdel{Repp}%DIFDELCMD < }%%%
\DIFdel{, A., }%DIFDELCMD < {%%%
\DIFdel{Ebeling}%DIFDELCMD < }%%%
\DIFdel{, H., }%DIFDELCMD < \& {%%%
\DIFdel{Richard}%DIFDELCMD < }%%%
\DIFdel{, J. 2016, }%DIFDELCMD < \mnras%%%
\DIFdel{, 457, 1399
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Ricker} {et~al.}(2014){Ricker}, {Winn}, {Vanderspek}, {Latham},
%DIFDELCMD <   {Bakos}, {Bean}, {Berta-Thompson}, {Brown}, {Buchhave}, {Butler}, {Butler},
%DIFDELCMD <   {Chaplin}, {Charbonneau}, {Christensen-Dalsgaard}, {Clampin}, {Deming},
%DIFDELCMD <   {Doty}, {De Lee}, {Dressing}, {Dunham}, {Endl}, {Fressin}, {Ge}, {Henning},
%DIFDELCMD <   {Holman}, {Howard}, {Ida}, {Jenkins}, {Jernigan}, {Johnson}, {Kaltenegger},
%DIFDELCMD <   {Kawai}, {Kjeldsen}, {Laughlin}, {Levine}, {Lin}, {Lissauer}, {MacQueen},
%DIFDELCMD <   {Marcy}, {McCullough}, {Morton}, {Narita}, {Paegert}, {Palle}, {Pepe},
%DIFDELCMD <   {Pepper}, {Quirrenbach}, {Rinehart}, {Sasselov}, {Sato}, {Seager},
%DIFDELCMD <   {Sozzetti}, {Stassun}, {Sullivan}, {Szentgyorgyi}, {Torres}, {Udry}, \&
%DIFDELCMD <   {Villasenor}}]{ricker14}
%DIFDELCMD < {%%%
\DIFdel{Ricker}%DIFDELCMD < }%%%
\DIFdel{, G.~R., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2014, in }%DIFDELCMD < \procspie%%%
\DIFdel{, Vol. 9143, Space Telescopes and
  Instrumentation 2014: Optical, Infrared, and Millimeter Wave, 914320
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Roberts-Borsani} {et~al.}(2016){Roberts-Borsani}, {Bouwens},
%DIFDELCMD <   {Oesch}, {Labbe}, {Smit}, {Illingworth}, {van Dokkum}, {Holden}, {Gonzalez},
%DIFDELCMD <   {Stefanon}, {Holwerda}, \& {Wilkins}}]{Roberts-Borsani2016}
%DIFDELCMD < {%%%
\DIFdel{Roberts-Borsani}%DIFDELCMD < }%%%
\DIFdel{, G.~W., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2016, }%DIFDELCMD < \apj%%%
\DIFdel{, 823, 143
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Robertson} {et~al.}(2013){Robertson}, {Furlanetto}, {Schneider},
%DIFDELCMD <   {Charlot}, {Ellis}, {Stark}, {McLure}, {Dunlop}, {Koekemoer}, {Schenker},
%DIFDELCMD <   {Ouchi}, {Ono}, {Curtis-Lake}, {Rogers}, {Bowler}, \&
%DIFDELCMD <   {Cirasuolo}}]{Robertson2013}
%DIFDELCMD < {%%%
\DIFdel{Robertson}%DIFDELCMD < }%%%
\DIFdel{, B.~E., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
...
%DIFDELCMD < \bibitem[{{Schmidt} {et~al.}(2014){Schmidt}, {Treu}, {Trenti}, {Bradley},
%DIFDELCMD <   {Kelly}, {Oesch}, {Holwerda}, {Shull}, \& {Stiavelli}}]{Schmidt2014}
%DIFDELCMD < {%%%
\DIFdel{Schmidt}%DIFDELCMD < }%%%
\DIFdel{, K.~B., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2014, }%DIFDELCMD < \apj%%%
\DIFdel{, 786, 57
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{SDSS Collaboration} {et~al.}(2016){SDSS Collaboration}, {Albareti},
%DIFDELCMD <   {Allende Prieto}, {Almeida}, {Anders}, {Anderson}, {Andrews},
%DIFDELCMD <   {Aragon-Salamanca}, {Argudo-Fernandez}, {Armengaud}, \& et~al.}]{sdssdr13}
%DIFDELCMD < {%%%
\DIFdel{SDSS Collaboration}%DIFDELCMD < } {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2016, ArXiv e-prints
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Seymour} {et~al.}(2007){Seymour}, {Stern}, {De Breuck}, {Vernet},
%DIFDELCMD <   {Rettura}, {Dickinson}, {Dey}, {Eisenhardt}, {Fosbury}, {Lacy}, {McCarthy},
%DIFDELCMD <   {Miley}, {Rocca-Volmerange}, {R{\"o}ttgering}, {Stanford}, {Teplitz}, {van
%DIFDELCMD <   Breugel}, \& {Zirm}}]{seymour07}
%DIFDELCMD < {%%%
\DIFdel{Seymour}%DIFDELCMD < }%%%
\DIFdel{, N., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2007, }%DIFDELCMD < \apjs%%%
\DIFdel{, 171, 353
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Silva} {et~al.}(2013){Silva}, {Santos}, {Gong}, {Cooray}, \&
%DIFDELCMD <   {Bock}}]{silva12}
%DIFDELCMD < {%%%
\DIFdel{Silva}%DIFDELCMD < }%%%
\DIFdel{, M.~B., }%DIFDELCMD < {%%%
\DIFdel{Santos}%DIFDELCMD < }%%%
\DIFdel{, M.~G., }%DIFDELCMD < {%%%
\DIFdel{Gong}%DIFDELCMD < }%%%
\DIFdel{, Y., }%DIFDELCMD < {%%%
\DIFdel{Cooray}%DIFDELCMD < }%%%
\DIFdel{, A., }%DIFDELCMD < \& {%%%
...
%DIFDELCMD < \bibitem[{{Smit} {et~al.}(2014){Smit}, {Bouwens}, {Labb{\'e}}, {Zheng},
%DIFDELCMD <   {Bradley}, {Donahue}, {Lemze}, {Moustakas}, {Umetsu}, {Zitrin}, {Coe},
%DIFDELCMD <   {Postman}, {Gonzalez}, {Bartelmann}, {Ben{\'{\i}}tez}, {Broadhurst}, {Ford},
%DIFDELCMD <   {Grillo}, {Infante}, {Jimenez-Teja}, {Jouvel}, {Kelson}, {Lahav}, {Maoz},
%DIFDELCMD <   {Medezinski}, {Melchior}, {Meneghetti}, {Merten}, {Molino}, {Moustakas},
%DIFDELCMD <   {Nonino}, {Rosati}, \& {Seitz}}]{brightemissionlines}
%DIFDELCMD < {%%%
\DIFdel{Smit}%DIFDELCMD < }%%%
\DIFdel{, R., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2014, }%DIFDELCMD < \apj%%%
\DIFdel{, 784, 58
...
%DIFDELCMD < \bibitem[{{Spergel} {et~al.}(2013){Spergel}, {Gehrels}, {Breckinridge},
%DIFDELCMD <   {Donahue}, {Dressler}, {Gaudi}, {Greene}, {Guyon}, {Hirata}, {Kalirai},
%DIFDELCMD <   {Kasdin}, {Moos}, {Perlmutter}, {Postman}, {Rauscher}, {Rhodes}, {Wang},
%DIFDELCMD <   {Weinberg}, {Centrella}, {Traub}, {Baltay}, {Colbert}, {Bennett},
%DIFDELCMD <   {Kiessling}, {Macintosh}, {Merten}, {Mortonson}, {Penny}, {Rozo},
%DIFDELCMD <   {Savransky}, {Stapelfeldt}, {Zu}, {Baker}, {Cheng}, {Content}, {Dooley},
%DIFDELCMD <   {Foote}, {Goullioud}, {Grady}, {Jackson}, {Kruk}, {Levine}, {Melton},
%DIFDELCMD <   {Peddie}, {Ruffa}, \& {Shaklan}}]{Spergel2013}
%DIFDELCMD < {%%%
\DIFdel{Spergel}%DIFDELCMD < }%%%
\DIFdel{, D., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2013, ArXiv e-prints
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Sullivan} {et~al.}(2012){Sullivan}, {Morales}, {Hazelton}, {Arcus},
%DIFDELCMD <   {Barnes}, {Bernardi}, {Briggs}, {Bowman}, {Bunton}, {Cappallo}, {Corey},
%DIFDELCMD <   {Deshpande}, {deSouza}, {Emrich}, {Gaensler}, {Goeke}, {Greenhill}, {Herne},
%DIFDELCMD <   {Hewitt}, {Johnston-Hollitt}, {Kaplan}, {Kasper}, {Kincaid}, {Koenig},
%DIFDELCMD <   {Kratzenberg}, {Lonsdale}, {Lynch}, {McWhirter}, {Mitchell}, {Morgan},
%DIFDELCMD <   {Oberoi}, {Ord}, {Pathikulangara}, {Prabu}, {Remillard}, {Rogers}, {Roshi},
%DIFDELCMD <   {Salah}, {Sault}, {Udaya Shankar}, {Srivani}, {Stevens}, {Subrahmanyan},
%DIFDELCMD <   {Tingay}, {Wayth}, {Waterson}, {Webster}, {Whitney}, {Williams}, {Williams},
%DIFDELCMD <   \& {Wyithe}}]{fhd}
%DIFDELCMD < {%%%
\DIFdel{Sullivan}%DIFDELCMD < }%%%
\DIFdel{, I.~S., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2012, ApJ, 759, 17
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Sullivan} \& {Simcoe}(2012)}]{sullivan12}
%DIFDELCMD < {%%%
\DIFdel{Sullivan}%DIFDELCMD < }%%%
\DIFdel{, P.~W., }%DIFDELCMD < \& {%%%
\DIFdel{Simcoe}%DIFDELCMD < }%%%
\DIFdel{, R.~A. 2012, }%DIFDELCMD < \pasp%%%
\DIFdel{, 124, 1336
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Tegmark}(1997)}]{Maxpowerspeclossless}
%DIFDELCMD < {%%%
\DIFdel{Tegmark}%DIFDELCMD < }%%%
\DIFdel{, M. 1997, }%DIFDELCMD < \prd%%%
\DIFdel{, 55, 5895
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Tegmark} \& {Zaldarriaga}(2002)}]{tegmark02b}
%DIFDELCMD < {%%%
\DIFdel{Tegmark}%DIFDELCMD < }%%%
\DIFdel{, M., }%DIFDELCMD < \& {%%%
\DIFdel{Zaldarriaga}%DIFDELCMD < }%%%
\DIFdel{, M. 2002, }%DIFDELCMD < \prd%%%
\DIFdel{, 66, 103508
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Tegmark} {et~al.}(2002){Tegmark}, {Dodelson}, {Eisenstein},
%DIFDELCMD <   {Narayanan}, {Scoccimarro}, {Scranton}, {Strauss}, {Connolly}, {Frieman},
%DIFDELCMD <   {Gunn}, {Hui}, {Jain}, {Johnston}, {Kent}, {Loveday}, {Nichol}, {O'Connell},
%DIFDELCMD <   {Sheth}, {Stebbins}, {Szalay}, {Szapudi}, {Vogeley}, {Zehavi}, {Annis},
%DIFDELCMD <   {Bahcall}, {Brinkmann}, {Csabai}, {Doi}, {Fukugita}, {Hennessy},
%DIFDELCMD <   {Ivez{\'{\i}}c}, {Knapp}, {Lamb}, {Lee}, {Lupton}, {McKay}, {Kunszt}, {Munn},
%DIFDELCMD <   {Peoples}, {Pier}, {Richmond}, {Rockosi}, {Schlegel}, {Stoughton}, {Tucker},
%DIFDELCMD <   {Yanny}, \& {York}}]{tegmark02}
%DIFDELCMD < {%%%
\DIFdel{Tegmark}%DIFDELCMD < }%%%
\DIFdel{, M., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
...
%DIFDELCMD < \bibitem[{Tingay {et~al.}(2013)Tingay, Goeke, Bowman, Emrich, Ord, Mitchell,
%DIFDELCMD <   Morales, Booler, Crosse, Wayth, Lonsdale, Tremblay, Pallot, Colegate,
%DIFDELCMD <   Wicenec, Kudryavtseva, Arcus, Barnes, Bernardi, Briggs, Burns, Bunton,
%DIFDELCMD <   Cappallo, Corey, Deshpande, Desouza, Gaensler, Greenhill, Hall, Hazelton,
%DIFDELCMD <   Herne, Hewitt, Johnston-Hollitt, Kaplan, Kasper, Kincaid, Koenig,
%DIFDELCMD <   Kratzenberg, Lynch, Mckinley, Mcwhirter, Morgan, Oberoi, Pathikulangara,
%DIFDELCMD <   Prabu, Remillard, Rogers, Roshi, Salah, Sault, Udaya-Shankar, Schlagenhaufer,
%DIFDELCMD <   Srivani, Stevens, Subrahmanyan, Waterson, Webster, Whitney, Williams,
%DIFDELCMD <   Williams, \& Wyithe}]{tingay13}
%DIFDELCMD < %%%
\DIFdel{Tingay, S.~J., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2013, PASA, 30
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Tonry}(2011)}]{tonry11}
%DIFDELCMD < {%%%
\DIFdel{Tonry}%DIFDELCMD < }%%%
\DIFdel{, J.~L. 2011, }%DIFDELCMD < \pasp%%%
\DIFdel{, 123, 58
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Tonry} {et~al.}(2012){Tonry}, {Stubbs}, {Lykke}, {Doherty},
%DIFDELCMD <   {Shivvers}, {Burgett}, {Chambers}, {Hodapp}, {Kaiser}, {Kudritzki},
%DIFDELCMD <   {Magnier}, {Morgan}, {Price}, \& {Wainscoat}}]{tonry12}
%DIFDELCMD < {%%%
\DIFdel{Tonry}%DIFDELCMD < }%%%
\DIFdel{, J.~L., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2012, }%DIFDELCMD < \apj%%%
\DIFdel{, 750, 99
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Trenti} {et~al.}(2011){Trenti}, {Bradley}, {Stiavelli}, {Oesch},
%DIFDELCMD <   {Treu}, {Bouwens}, {Shull}, {MacKenty}, {Carollo}, \&
%DIFDELCMD <   {Illingworth}}]{Trenti2011}
%DIFDELCMD < {%%%
\DIFdel{Trenti}%DIFDELCMD < }%%%
\DIFdel{, M., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2011, }%DIFDELCMD < \apjl%%%
\DIFdel{, 727, L39
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{van Haarlem} {et~al.}(2013){van Haarlem}, {Wise}, {Gunst}, {Heald},
%DIFDELCMD <   {McKean}, {Hessels}, {de Bruyn}, {Nijboer}, {Swinbank}, {Fallows},
%DIFDELCMD <   {Brentjens}, {Nelles}, {Beck}, {Falcke}, {Fender}, {H{\"o}randel},
%DIFDELCMD <   {Koopmans}, {Mann}, {Miley}, {R{\"o}ttgering}, {Stappers}, {Wijers},
%DIFDELCMD <   {Zaroubi}, {van den Akker}, {Alexov}, {Anderson}, {Anderson}, {van Ardenne},
%DIFDELCMD <   {Arts}, {Asgekar}, {Avruch}, {Batejat}, {B{\"a}hren}, {Bell}, {Bell}, {van
%DIFDELCMD <   Bemmel}, {Bennema}, {Bentum}, {Bernardi}, {Best}, {B{\^i}rzan}, {Bonafede},
%DIFDELCMD <   {Boonstra}, {Braun}, {Bregman}, {Breitling}, {van de Brink}, {Broderick},
%DIFDELCMD <   {Broekema}, {Brouw}, {Br{\"u}ggen}, {Butcher}, {van Cappellen}, {Ciardi},
%DIFDELCMD <   {Coenen}, {Conway}, {Coolen}, {Corstanje}, {Damstra}, {Davies}, {Deller},
%DIFDELCMD <   {Dettmar}, {van Diepen}, {Dijkstra}, {Donker}, {Doorduin}, {Dromer}, {Drost},
%DIFDELCMD <   {van Duin}, {Eisl{\"o}ffel}, {van Enst}, {Ferrari}, {Frieswijk}, {Gankema},
%DIFDELCMD <   {Garrett}, {de Gasperin}, {Gerbers}, {de Geus}, {Grie{\ss}meier}, {Grit},
%DIFDELCMD <   {Gruppen}, {Hamaker}, {Hassall}, {Hoeft}, {Holties}, {Horneffer}, {van der
%DIFDELCMD <   Horst}, {van Houwelingen}, {Huijgen}, {Iacobelli}, {Intema}, {Jackson},
%DIFDELCMD <   {Jelic}, {de Jong}, {Juette}, {Kant}, {Karastergiou}, {Koers}, {Kollen},
%DIFDELCMD <   {Kondratiev}, {Kooistra}, {Koopman}, {Koster}, {Kuniyoshi}, {Kramer},
%DIFDELCMD <   {Kuper}, {Lambropoulos}, {Law}, {van Leeuwen}, {Lemaitre}, {Loose}, {Maat},
%DIFDELCMD <   {Macario}, {Markoff}, {Masters}, {McFadden}, {McKay-Bukowski}, {Meijering},
%DIFDELCMD <   {Meulman}, {Mevius}, {Middelberg}, {Millenaar}, {Miller-Jones}, {Mohan},
%DIFDELCMD <   {Mol}, {Morawietz}, {Morganti}, {Mulcahy}, {Mulder}, {Munk}, {Nieuwenhuis},
%DIFDELCMD <   {van Nieuwpoort}, {Noordam}, {Norden}, {Noutsos}, {Offringa}, {Olofsson},
%DIFDELCMD <   {Omar}, {Orr{\'u}}, {Overeem}, {Paas}, {Pandey-Pommier}, {Pandey}, {Pizzo},
%DIFDELCMD <   {Polatidis}, {Rafferty}, {Rawlings}, {Reich}, {de Reijer}, {Reitsma},
%DIFDELCMD <   {Renting}, {Riemers}, {Rol}, {Romein}, {Roosjen}, {Ruiter}, {Scaife}, {van
%DIFDELCMD <   der Schaaf}, {Scheers}, {Schellart}, {Schoenmakers}, {Schoonderbeek},
%DIFDELCMD <   {Serylak}, {Shulevski}, {Sluman}, {Smirnov}, {Sobey}, {Spreeuw}, {Steinmetz},
%DIFDELCMD <   {Sterks}, {Stiepel}, {Stuurwold}, {Tagger}, {Tang}, {Tasse}, {Thomas},
%DIFDELCMD <   {Thoudam}, {Toribio}, {van der Tol}, {Usov}, {van Veelen}, {van der Veen},
%DIFDELCMD <   {ter Veen}, {Verbiest}, {Vermeulen}, {Vermaas}, {Vocks}, {Vogt}, {de Vos},
%DIFDELCMD <   {van der Wal}, {van Weeren}, {Weggemans}, {Weltevrede}, {White}, {Wijnholds},
%DIFDELCMD <   {Wilhelmsson}, {Wucknitz}, {Yatawatta}, {Zarka}, {Zensus}, \& {van
%DIFDELCMD <   Zwieten}}]{lofar}
%DIFDELCMD < {%%%
\DIFdel{van Haarlem}%DIFDELCMD < }%%%
\DIFdel{, M.~P., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2013, }%DIFDELCMD < \aap%%%
\DIFdel{, 556, A2
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Wilkins} {et~al.}(2016){Wilkins}, {Bouwens}, {Oesch}, {Labb{\'e}},
%DIFDELCMD <   {Sargent}, {Caruana}, {Wardlow}, \& {Clay}}]{Wilkins12015}
%DIFDELCMD < {%%%
\DIFdel{Wilkins}%DIFDELCMD < }%%%
\DIFdel{, S.~M., }%DIFDELCMD < {%%%
\DIFdel{Bouwens}%DIFDELCMD < }%%%
\DIFdel{, R.~J., }%DIFDELCMD < {%%%
\DIFdel{Oesch}%DIFDELCMD < }%%%
\DIFdel{, P.~A., }%DIFDELCMD < {%%%
\DIFdel{Labb}%DIFDELCMD < {\'e}}%%%
\DIFdel{, I., }%DIFDELCMD < {%%%
\DIFdel{Sargent}%DIFDELCMD < }%%%
\DIFdel{,
  M., }%DIFDELCMD < {%%%
\DIFdel{Caruana}%DIFDELCMD < }%%%
\DIFdel{, J., }%DIFDELCMD < {%%%
\DIFdel{Wardlow}%DIFDELCMD < }%%%
\DIFdel{, J., }%DIFDELCMD < \& {%%%
\DIFdel{Clay}%DIFDELCMD < }%%%
\DIFdel{, S. 2016, }%DIFDELCMD < \mnras%%%
\DIFdel{, 455, 659
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Willott} {et~al.}(2003){Willott}, {Rawlings}, {Jarvis}, \&
%DIFDELCMD <   {Blundell}}]{Willott03}
%DIFDELCMD < {%%%
\DIFdel{Willott}%DIFDELCMD < }%%%
\DIFdel{, C.~J., }%DIFDELCMD < {%%%
\DIFdel{Rawlings}%DIFDELCMD < }%%%
\DIFdel{, S., }%DIFDELCMD < {%%%
\DIFdel{Jarvis}%DIFDELCMD < }%%%
\DIFdel{, M.~J., }%DIFDELCMD < \& {%%%
\DIFdel{Blundell}%DIFDELCMD < }%%%
\DIFdel{, K.~M. 2003,
  }%DIFDELCMD < \mnras%%%
\DIFdel{, 339, 173
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Wright} {et~al.}(2010){Wright}, {Eisenhardt}, {Mainzer}, {Ressler},
%DIFDELCMD <   {Cutri}, {Jarrett}, {Kirkpatrick}, {Padgett}, {McMillan}, {Skrutskie},
%DIFDELCMD <   {Stanford}, {Cohen}, {Walker}, {Mather}, {Leisawitz}, {Gautier}, {McLean},
%DIFDELCMD <   {Benford}, {Lonsdale}, {Blain}, {Mendez}, {Irace}, {Duval}, {Liu}, {Royer},
%DIFDELCMD <   {Heinrichsen}, {Howard}, {Shannon}, {Kendall}, {Walsh}, {Larsen}, {Cardon},
%DIFDELCMD <   {Schick}, {Schwalm}, {Abid}, {Fabinsky}, {Naes}, \& {Tsai}}]{Wright2010}
%DIFDELCMD < {%%%
\DIFdel{Wright}%DIFDELCMD < }%%%
\DIFdel{, E.~L., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2010, }%DIFDELCMD < \aj%%%
\DIFdel{, 140, 1868
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Wyithe} \& {Morales}(2007)}]{skew}
%DIFDELCMD < {%%%
\DIFdel{Wyithe}%DIFDELCMD < }%%%
\DIFdel{, J.~S.~B., }%DIFDELCMD < \& {%%%
\DIFdel{Morales}%DIFDELCMD < }%%%
\DIFdel{, M.~F. 2007, }%DIFDELCMD < \mnras%%%
\DIFdel{, 379, 1647
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Xu} {et~al.}(1994){Xu}, {Lisenfeld}, \& {Voelk}}]{xu94}
%DIFDELCMD < {%%%
\DIFdel{Xu}%DIFDELCMD < }%%%
\DIFdel{, C., }%DIFDELCMD < {%%%
\DIFdel{Lisenfeld}%DIFDELCMD < }%%%
\DIFdel{, U., }%DIFDELCMD < \& {%%%
\DIFdel{Voelk}%DIFDELCMD < }%%%
\DIFdel{, H.~J. 1994, }%DIFDELCMD < \aap%%%
\DIFdel{, 285, 19
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Yatawatta} {et~al.}(2013){Yatawatta}, {de Bruyn}, {Brentjens},
%DIFDELCMD <   {Labropoulos}, {Pandey}, {Kazemi}, {Zaroubi}, {Koopmans}, {Offringa},
%DIFDELCMD <   {Jeli{\'c}}, {Martinez Rubi}, {Veligatla}, {Wijnholds}, {Brouw}, {Bernardi},
%DIFDELCMD <   {Ciardi}, {Daiboo}, {Harker}, {Mellema}, {Schaye}, {Thomas}, {Vedantham},
%DIFDELCMD <   {Chapman}, {Abdalla}, {Alexov}, {Anderson}, {Avruch}, {Batejat}, {Bell},
%DIFDELCMD <   {Bell}, {Bentum}, {Best}, {Bonafede}, {Bregman}, {Breitling}, {van de Brink},
%DIFDELCMD <   {Broderick}, {Br{\"u}ggen}, {Conway}, {de Gasperin}, {de Geus}, {Duscha},
%DIFDELCMD <   {Falcke}, {Fallows}, {Ferrari}, {Frieswijk}, {Garrett}, {Griessmeier},
%DIFDELCMD <   {Gunst}, {Hassall}, {Hessels}, {Hoeft}, {Iacobelli}, {Juette},
%DIFDELCMD <   {Karastergiou}, {Kondratiev}, {Kramer}, {Kuniyoshi}, {Kuper}, {van Leeuwen},
%DIFDELCMD <   {Maat}, {Mann}, {McKean}, {Mevius}, {Mol}, {Munk}, {Nijboer}, {Noordam},
%DIFDELCMD <   {Norden}, {Orru}, {Paas}, {Pandey-Pommier}, {Pizzo}, {Polatidis}, {Reich},
%DIFDELCMD <   {R{\"o}ttgering}, {Sluman}, {Smirnov}, {Stappers}, {Steinmetz}, {Tagger},
%DIFDELCMD <   {Tang}, {Tasse}, {ter Veen}, {Vermeulen}, {van Weeren}, {Wise}, {Wucknitz},
%DIFDELCMD <   \& {Zarka}}]{lofareorpaper}
%DIFDELCMD < {%%%
\DIFdel{Yatawatta}%DIFDELCMD < }%%%
\DIFdel{, S., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
\DIFdel{2013, }%DIFDELCMD < \aap%%%
\DIFdel{, 550, A136
...
%DIFDELCMD < \bibitem[{{Yue} {et~al.}(2016){Yue}, {Ferrara}, \& {Salvaterra}}]{yue16}
%DIFDELCMD < {%%%
\DIFdel{Yue}%DIFDELCMD < }%%%
\DIFdel{, B., }%DIFDELCMD < {%%%
\DIFdel{Ferrara}%DIFDELCMD < }%%%
\DIFdel{, A., }%DIFDELCMD < \& {%%%
\DIFdel{Salvaterra}%DIFDELCMD < }%%%
\DIFdel{, R. 2016, ArXiv e-prints
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Yun} {et~al.}(2001){Yun}, {Reddy}, \& {Condon}}]{yun01}
%DIFDELCMD < {%%%
\DIFdel{Yun}%DIFDELCMD < }%%%
\DIFdel{, M.~S., }%DIFDELCMD < {%%%
\DIFdel{Reddy}%DIFDELCMD < }%%%
\DIFdel{, N.~A., }%DIFDELCMD < \& {%%%
\DIFdel{Condon}%DIFDELCMD < }%%%
\DIFdel{, J.~J. 2001, }%DIFDELCMD < \apj%%%
\DIFdel{, 554, 803
}%DIFDELCMD < 

%DIFDELCMD < \bibitem[{{Zemcov} {et~al.}(2014){Zemcov}, {Smidt}, {Arai}, {Bock}, {Cooray},
%DIFDELCMD <   {Gong}, {Kim}, {Korngut}, {Lam}, {Lee}, {Matsumoto}, {Matsuura}, {Nam},
%DIFDELCMD <   {Roudier}, {Tsumura}, \& {Wada}}]{zemcov14}
%DIFDELCMD < {%%%
\DIFdel{Zemcov}%DIFDELCMD < }%%%
\DIFdel{, M., }%DIFDELCMD < {%%%
\DIFdel{et~al.}%DIFDELCMD < } %%%
...
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \bibliography{xcor_paper_new}
\DIFaddend 
