...
review the reason we're doing this
correlations are awesome
early results are promising
intensity mapping offers a promising way to go below detection limits, probing the ionizing population
...
- we have shown that radio/MIR foregrounds are measurable correlated due to geometric effects, no radio/NIR xcor seen, but likely would see it in deeper surveys
 => more detailed modeling needed to understand this xcor as a function of flux cut
 
- you can do 2D NIR intensity mapping from the ground, and see the NIRB fluctuations

- we have simulated for the first time how the signal in 2D experiments relates to that in 3D experiments

- first limits on the EOR 21cm-Lyalpha cross spectrum

- realistic next generation experiments can begin to reach the cross spectrum

=> wide surveys with TESS, MWA, and HERA in the near future, and SKA/SPHEREx in the coming decade


\begin{acknowledgments}
We acknowledge helpful discussions on optimal quadratic estimators with Adrian Liu, Josh Dillon, and Aaron Ewall-Wice, and discussions on MWA image products with Adam Beardsley, Danny Jacobs, and Nichole Barry. Our analysis code is publicly available at \ULurl{https://github.com/abrahamneben/21cmIRxcor}
\end{acknowledgments}
